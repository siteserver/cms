...
namespace SiteServer.API.Controllers.Pages.Settings.Sites
{
    ...
    [RoutePrefix("pages/settings/sitesUrl")]
    public class PagesSitesUrlController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetConfig()
        {
            try
            {
                ...
                if (!request.IsAdminLoggin ||
                    !await request.AdminPermissionsImpl.HasSystemPermissionsAsync(Constants.AppPermissions.SettingsSitesUrl))
                {
                    return Unauthorized();
                }
