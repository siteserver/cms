...
namespace SiteServer.API.Controllers.Pages.Cms
{
    ...
    public partial class PagesLibraryTextController : ApiController
    {
        ...
        public async Task<LibraryText> Create()
        {
            ...
            var (_, wordContent) = await WordManager.GetWordAsync(null, false, false, true, true, true, true, false, filePath);
        ...
        public async Task<DefaultResult> Delete([FromUri]int id)
        {
            var auth = await AuthenticatedRequest.GetAuthAsync();
        ...
        public async Task<DefaultResult> DeleteGroup([FromUri]int id)
        {
            var auth = await AuthenticatedRequest.GetAuthAsync();
