...
namespace SiteServer.API.Controllers.Pages.Cms
{
    ...
    [RoutePrefix("pages/cms/tableStyleChannel")]
    public partial class PagesTableStyleChannelController : ApiController
    {
        ...
        public async Task<GenericResult<string>> Export([FromBody] ChannelRequest request)
        {
            ...
            var fileName =
                await ExportObject.ExportRootSingleTableStyleAsync(DataProvider.ChannelRepository.TableName,
