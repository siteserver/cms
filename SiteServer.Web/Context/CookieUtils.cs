...
namespace SiteServer.API.Context
{
    public static class CookieUtils
    {
        ...
        {
            cookie.Value = isEncrypt ? TranslateUtils.EncryptStringBySecretKey(cookie.Value, WebConfigUtils.SecretKey) : cookie.Value;
        ...
        public static string GetCookie(string name)
        {
            ...
            return TranslateUtils.DecryptStringBySecretKey(value, WebConfigUtils.SecretKey);
        }
