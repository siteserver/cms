var $urlUploadVideo = apiUrl + '/pages/cms/editorLayerVideo/actions/uploadVideo?siteId=' + utils.getQueryInt('siteId') + '&channelId=' + utils.getQueryInt('channelId');
var $urlUploadImage = apiUrl + '/pages/cms/editorLayerVideo/actions/uploadImage?siteId=' + utils.getQueryInt('siteId') + '&channelId=' + utils.getQueryInt('channelId');
...
var methods = {
  ...
  btnSubmitClick: function () {
    ...
    parent.insertHtml($this.attributeName, '<img ' + imageUrl + isAutoPlay + width + height + ' playUrl="' + this.form.videoUrl + '" class="siteserver-stl-player" style="width: 333px; height: 333px" src="../assets/ueditor/video-clip.png" /><br/>');
