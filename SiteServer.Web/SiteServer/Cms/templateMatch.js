var $url = '/pages/cms/templateMatch';
...
var methods = {
  ...
  filterNode: function(value, data) {
    ...
    if (value.channelName && value.channelTemplateId && value.contentTemplateId) {
      return data.label.indexOf(value.channelName) !== -1 && data.dict.channelTemplateId === value.channelTemplateId && data.dict.contentTemplateIds.indexOf(value.contentTemplateId) !== -1;
      ...
      return data.label.indexOf(value.channelName) !== -1 && data.dict.contentTemplateIds.indexOf(value.contentTemplateId) !== -1;
    } else if (value.channelTemplateId && value.contentTemplateId) {
      return data.channelTemplateId === value.channelTemplateId && data.dict.contentTemplateIds.indexOf(value.contentTemplateId) !== -1;
    } else if (value.channelName) {
      return data.label.indexOf(value.channelName) !== -1;
    } else if (value.contentTemplateId) {
      return data.dict.contentTemplateIds.indexOf(value.contentTemplateId) !== -1;
    } else if (value.channelTemplateId) {
      return data.dict.channelTemplateId === value.channelTemplateId;
    }
    return true;
  },
