      ...
      <form runat="server">
        ...
        <script language="JavaScript">
          ...
          function loadingChannels(tr, img, div, templateType) {
            ...
            var pars = 'publishmentSystemID=<%=base.Request.QueryString["PublishmentSystemID"]%>&templateType=' +
              templateType;
        ...
        <table class="table noborder table-condensed table-hover">
          ...
          <tr treeitemlevel="1">
            <td align="left" nowrap>
              ...
              <a href='pageTemplate.aspx?PublishmentSystemID=<%=base.Request.QueryString["PublishmentSystemID"]%>'
                islink='true' onclick='fontWeightLink(this)' target='management'>所有模板</a>
              </a>&nbsp;
          ...
          <tr treeitemlevel="2">
            <td align="left" nowrap>
              ...
              <img align="absmiddle" style="cursor: pointer" onclick="displayChildren(this);" isajax="true" isopen="false"
                templatetype="IndexPageTemplate" src="../assets/icons/tree/plus.gif" />
              <img align="absmiddle" border="0" src="../assets/icons/tree/folder.gif" />&nbsp;
              ...
              <span style="font-size: 8pt; font-family: arial" class="gray">(
                <%=GetCount("IndexPageTemplate")%>)</span>
            </td>
          </tr>
          ...
          <tr treeitemlevel="2">
            <td align="left" nowrap>
              <img align="absmiddle" src="../assets/icons/tree/empty.gif" />
              <img align="absmiddle" style="cursor: pointer" onclick="displayChildren(this);" isajax="true" isopen="false"
                templatetype="ChannelTemplate" src="../assets/icons/tree/plus.gif" />
              <img align="absmiddle" border="0" src="../assets/icons/tree/folder.gif" />&nbsp;
          ...
          <tr treeitemlevel="2">
            <td align="left" nowrap>
              <img align="absmiddle" src="../assets/icons/tree/empty.gif" />
              <img align="absmiddle" style="cursor: pointer" onclick="displayChildren(this);" isajax="true" isopen="false"
                templatetype="ContentTemplate" src="../assets/icons/tree/plus.gif" />
              <img align="absmiddle" border="0" src="../assets/icons/tree/folder.gif" />&nbsp;
          ...
          <tr treeitemlevel="2">
            <td align="left" nowrap>
              <img align="absmiddle" src="../assets/icons/tree/empty.gif" />
              <img align="absmiddle" style="cursor: pointer" onclick="displayChildren(this);" isajax="true" isopen="false"
                templatetype="FileTemplate" src="../assets/icons/tree/plus.gif" />
              <img align="absmiddle" border="0" src="../assets/icons/tree/folder.gif" />&nbsp;
