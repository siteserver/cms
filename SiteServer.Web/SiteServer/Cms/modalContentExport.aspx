      ...
      <form runat="server">
        ...
        <div class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-xs-3 control-label text-right">导出类型</label>
            <div class="col-xs-8">
          ...
          <div class="form-group">
            <label class="col-xs-3 control-label text-right">时间段选择</label>
            <div class="col-xs-8">
          ...
          <asp:PlaceHolder ID="PhDisplayAttributes" runat="server">
            <div class="form-group">
              <label class="col-xs-3 control-label text-right">选择需要导出的字段</label>
              <div class="col-xs-8">
          ...
          <div class="form-group">
            <label class="col-xs-3 control-label text-right">内容状态</label>
            <div class="col-xs-8">
