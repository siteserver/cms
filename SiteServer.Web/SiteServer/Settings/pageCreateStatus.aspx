          ...
          for (var i = 0; i < tasks.length; i++) {
            ...
            if (task.isExecuting) {
              $('#tasks').append(
                ...
                task.type +
                '</label><div class="col-10"><div class="progress progress-lg m-b-5" style="margin-top: 18px"><div class="progress-bar progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="96" aria-valuemin="0" aria-valuemax="100" style="width: 100%;">' +
                task.name + '</div></div></div></div>');
            } else if (task.isPending) {
              $('#tasks').append(
                '<div class="form-group form-row"><label for="range_01" class="col-2 col-form-label">' +
                task.type +
                '</label><div class="col-10"><div class="progress progress-lg m-b-5" style="margin-top: 18px"><div class="progress-bar progress-bar-warning progress-bar-striped active" role="progressbar" aria-valuenow="96" aria-valuemin="0" aria-valuemax="100" style="width: 100%;">' +
                task.name + '</div></div></div></div>');
            } else {
              if (task.isSuccess) {
                $('#tasks').append(
                  '<div class="form-group form-row"><label for="range_01" class="col-2 col-form-label">' +
                  task.type +
                  '</label><div class="col-10"><div class="progress progress-lg m-b-5" style="margin-top: 18px"><div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="96" aria-valuemin="0" aria-valuemax="100" style="width: 100%;"><a href="' +
                  getRedirectUrl(task) + '" target="_blank" style="color:#fff;">' + task.name + '（用时：' + task.timeSpan +
                  '）' +
                  '</a></div></div></div></div>');
              } else {
                $('#tasks').append(
                  '<div class="form-group form-row"><label for="range_01" class="col-2 col-form-label">' +
                  task.type +
                  '</label><div class="col-10"><div class="progress progress-lg m-b-5" style="margin-top: 18px"><div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="96" aria-valuemin="0" aria-valuemax="100" style="width: 100%;">' +
        ...
        <div class="card-box">
          ...
          <div id="tasks">
            <div class="progress">
              ...
              <div role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 10%;"
                class="progress-bar progress-bar-info"></div>
              <div role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 15%;"
                class="progress-bar progress-bar-warning progress-bar-striped active"></div>
              <div role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 30%;"
