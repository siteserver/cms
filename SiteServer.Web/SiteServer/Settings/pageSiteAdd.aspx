...
<body>
  <form class="m-l-15 m-r-15" runat="server">
    ...
    <div class="card-box">
      <div class="m-t-0 header-title"> 创建新站点 <input type="hidden" id="HihSiteTemplateDir" value="" runat="server" />
        <input type="hidden" id="HihOnlineTemplateName" value="" runat="server" />
      </div>
      <asp:PlaceHolder id="PhSource" runat="server">
        <p class="text-muted font-13 m-b-25"> 欢迎使用创建新站点向导，请选择创建站点的方式 </p>
      ...
      <asp:PlaceHolder id="PhSiteTemplates" visible="false" runat="server">
        <p class="text-muted font-13 m-b-25"> 请选择站点模板 </p>
      ...
      <asp:PlaceHolder id="PhOnlineTemplates" visible="false" runat="server">
        <p class="text-muted font-13 m-b-25"> 请选择在线模板，本页面只显示部分免费模板，更多站点模板请访问官网： <a href="https://www.siteserver.cn/templates"
            target="_blank">https://www.siteserver.cn/templates</a>
        </p>
        <div class="panel panel-default">
          <div class="panel-body p-0">
            <div class="table-responsive">
      ...
      <asp:PlaceHolder id="PhSubmit" visible="false" runat="server">
        <p class="text-muted font-13 m-b-25"> 在此设置新建站点的名称、文件夹以及内容表等信息 </p>
        <div class="form-group">
          <label class="col-form-label">创建站点方式</label>
        ...
        <div class="form-group">
          <label class="col-form-label"> 站点级别 </label>
        ...
        <asp:PlaceHolder id="PhIsImportContents" runat="server">
          <div class="form-group">
            <label class="col-form-label"> 是否导入栏目及内容 </label>
        ...
        <asp:PlaceHolder id="PhIsImportTableStyles" runat="server">
          <div class="form-group">
            <label class="col-form-label"> 是否导入表单样式 </label>
