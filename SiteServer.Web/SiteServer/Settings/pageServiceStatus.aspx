  ...
  <%@ Register TagPrefix="bairong" Namespace="SiteServer.BackgroundPages.Controls" Assembly="SiteServer.BackgroundPages" %>
    ...
    <body>
      <form class="m-l-15 m-r-15" runat="server">
        ...
        <asp:PlaceHolder id="PhOnline" runat="server">
          <div class="alert alert-success">
            <h4>siteserver.exe 服务组件已启动并处于正常运行状态</h4>
          </div>
          ...
          <script type="text/javascript">
            $(function () {
              ...
              create.client.show = function (isOnline, tasks, channelsCount, contentsCount, filesCount) {
                ...
                channelsCount ? $('#channelsCount').css('color', '#fa0') : $('#channelsCount').css('color',
                  '#00b19d');
                $('#contentsCount').text(contentsCount);
                contentsCount ? $('#contentsCount').css('color', '#fa0') : $('#contentsCount').css('color',
                  '#00b19d');
                ...
                setTimeout(function () {
                  create.server.getTasks(0);
                }, 3000);
              };
              create.client.next = function (total) {
                if (total) {
                  create.server.execute(0);
                }
              };
