<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.Settings.ModalTableStylesAdd" Trace="false" %>
...
<bairong:alerts text="多个字段之间用换行分割，字段显示名称可以放到括号中，如：字段名称(显示名称)，不设置显示名称将默认使用字段名称" runat="server"></bairong:alerts>
  ...
  <table class="table table-noborder table-hover">
    ...
    <tr>
      ...
      <td colspan="3"><asp:RadioButtonList id="IsVisible" RepeatDirection="Horizontal" class="noborder" runat="server">
