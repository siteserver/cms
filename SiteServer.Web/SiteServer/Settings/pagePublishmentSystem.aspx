<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.Settings.PagePublishmentSystem" EnableViewState="false" %>
        ...
        <asp:DataGrid ID="dgContents" ShowHeader="true" AutoGenerateColumns="false" HeaderStyle-CssClass="info thead" CssClass="table table-bordered table-hover"
          ...
          <Columns>
            ...
            <asp:TemplateColumn HeaderText="保存为站点模板">
              <ItemTemplate>
                <nobr>
                  <a href="pageSiteTemplateSave.aspx?PublishmentSystemID=<%# Container.DataItem%>">保存</a>
                </nobr>
              </ItemTemplate>
            ...
            <asp:TemplateColumn HeaderText="修改属性">
              <ItemTemplate>
                <nobr>
                  <a href="pagePublishmentSystemEdit.aspx?PublishmentSystemID=<%# Container.DataItem%>">修改</a>
                </nobr>
              </ItemTemplate>
            ...
            <asp:TemplateColumn HeaderText="整站替换">
              <ItemTemplate>
                <nobr>
                  <a href="pagePublishmentSystemReplace.aspx?PublishmentSystemID=<%# Container.DataItem%>">替换</a>
                </nobr>
              </ItemTemplate>
              <ItemStyle Width="60" CssClass="center" />
            </asp:TemplateColumn>
