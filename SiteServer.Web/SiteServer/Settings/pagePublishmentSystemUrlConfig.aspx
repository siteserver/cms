<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.Settings.PagePublishmentSystemUrlConfig" %>
  <%@ Register TagPrefix="bairong" Namespace="SiteServer.BackgroundPages.Controls" Assembly="SiteServer.BackgroundPages" %>
    ...
    <body>
      ...
      <form class="container" runat="server">
        ...
        <div class="raw">
          <div class="card-box">
            <h4 class="m-t-0 header-title"><b>访问地址设置</b></h4>
            ...
            <div class="form-horizontal">
              ...
              <asp:PlaceHolder ID="PhSeparatedAssets" runat="server">
                <div class="form-group">
                  ...
                  <div class="col-sm-1">
                    <asp:RequiredFieldValidator ControlToValidate="TbSeparatedAssetsUrl" ErrorMessage=" *" ForeColor="red" Display="Dynamic" runat="server"
                    />
              ...
              <div class="form-group m-b-0">
                <div class="col-sm-offset-3 col-sm-9">
                  ...
                  <input type="button" value="返 回" class="btn btn-default m-l-10" onclick="location.href = 'pagePublishmentSystemUrl.aspx'">
                </div>
              </div>
