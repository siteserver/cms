...
<body>
  <form class="m-l-15 m-r-15" runat="server">
    <div id="main" class="card-box">
      <h4 class="text-dark  header-title m-t-0"> SiteServer CMS 数据库升级向导 </h4>
      <p class="text-muted m-b-25 font-13"> 欢迎来到SiteServer CMS 数据库升级向导！ </p>
      ...
      <div id="phStep1">
        ...
        <div class="jumbotron">
          ...
          <p class="lead"> 升级向导将逐一检查数据库字段、将数据库结构更新至最新版本。 </p>
        </div>
        <hr />
      ...
      <div id="phStep3" style="display: none">
        ...
        <div class="alert alert-success" role="alert">
          ...
          <p> 恭喜，您已经完成了 SiteServer CMS 数据库的升级 <a class="btn btn-success m-l-5" href="<%=AdminUrl%>">进入后台</a>
          </p>
          <hr>
