<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.Plugins.PageGatherDatabaseRuleAdd" %>
        ...
        <div class="popover popover-static">
          ...
          <div class="popover-content">
            ...
            <asp:PlaceHolder ID="GatherTableMatch" runat="server" Visible="false">
              ...
              <table class="table noborder table-hover">
                <tr>
                  <td class="align-right">采集数据库：
                    <asp:Literal ID="TableName" runat="server"></asp:Literal>
                  </td>
                  <td width="50"></td>
                  <td>内容数据库：
                    <asp:Literal ID="TableNameToMatch" runat="server"></asp:Literal>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <p>
                      <asp:Button class="btn" ID="Add" Text=" <- " OnClick="Add_OnClick" runat="server" />
                    </p>
                    <p>
                      <asp:Button class="btn" ID="Delete" Text=" -> " OnClick="Delete_OnClick" runat="server" />
                    </p>
                  </td>
                  <td>
