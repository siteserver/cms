<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.Plugins.PageGatherRule" %>
    ...
    <body>
      <form class="form-inline" runat="server">
        ...
        <ul class="breadcrumb breadcrumb-button">
          <input type="button" class="btn btn-success" onclick="location.href='pageGatherRuleAdd.aspx?PublishmentSystemID=<%=PublishmentSystemId%>';"
            value="添加采集规则" />
