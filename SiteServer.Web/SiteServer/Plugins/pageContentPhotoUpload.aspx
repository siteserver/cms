<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.Plugins.PageContentPhotoUpload" %>
...
<form class="form-inline" runat="server">
  ...
  <div class="popover popover-static">
    ...
    <tr>
      <td>
      	<img id="imgPhoto_0" style="border: #ccc 1px solid; padding:1px;<%=GetPreviewImageSize() %>" src="../assets/icons/preview.gif" />
