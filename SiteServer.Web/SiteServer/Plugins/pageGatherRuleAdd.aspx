<%@ Page Language="C#" ValidateRequest="false" Inherits="SiteServer.BackgroundPages.Plugins.PageGatherRuleAdd" %>
    ...
    <body>
      <form class="form-inline" runat="server">
        ...
        <script language="JavaScript" type="text/JavaScript">
          function AddOnPos(obj, charvalue) { //obj代表要插入字符的输入框 //value代表要插入的字符 obj.focus(); var r = document.selection.createRange();
          var ctr = obj.createTextRange(); var i; var s = obj.value; //注释掉的这种方法只能用在单行的输入框input内 //对多行输入框textarea无效 //r.setEndPoint("StartToStart",
          ctr); //i = r.text.length; //取到光标位置----Start---- var ivalue = "&^asdjfls2FFFF325%$^&"; r.text = ivalue; i = obj.value.indexOf(ivalue);
          r.moveStart("character", -ivalue.length); r.text = ""; //取到光标位置----End---- //插入字符 obj.value = s.substr(0, i) +
          charvalue + s.substr(i, s.length); ctr.collapse(true); ctr.moveStart("character", i + charvalue.length); ctr.select();
          }
        </script>
              ...
              <table class="table noborder table-hover">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    />
                    <asp:RequiredFieldValidator ControlToValidate="GatherNum" ErrorMessage=" *" ForeColor="red" Display="Dynamic" runat="server"
                    />
                    <asp:RegularExpressionValidator ControlToValidate="GatherNum" ValidationExpression="\d+" ErrorMessage="采集数只能是数字" foreColor="red"
                ...
                <tr>
                  <td>将首幅图片设为标题图片：</td>
                  <td>
                    <asp:RadioButtonList ID="IsSetFirstImageAsImageUrl" RepeatDirection="Horizontal" class="radiobuttonlist" runat="server">
              ...
              <table class="table noborder table-hover">
                <tr>
                  ...
                  <td colspan="3">
                    <table cellpadding="4" cellspacing="4" width="100%">
                      <tr>
                        <td>
                          <asp:CheckBox ID="GatherUrlIsCollection" runat="server" AutoPostBack="true" OnCheckedChanged="GatherUrl_CheckedChanged" Text="从多个网址"
                      ...
                      <tr id="GatherUrlSerializeRow" runat="server">
                        <td>
                          <asp:TextBox Columns="60" ID="GatherUrlSerialize" runat="server" /> 变动数字:
                          <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=GatherUrlSerialize.ClientID%>'), '*');"
                            title="遇到变动数字用*代替">
                            <font color="#0000FF">*</font>&nbsp;</a>
                          <br>
                          <br> 变动数字范围: 从
                          <asp:TextBox Columns="5" ID="SerializeFrom" Text="1" runat="server" /> 到
                          <asp:TextBox Columns="5" ID="SerializeTo" Text="10" runat="server" /> 数字变动倍数:
                          ...
                          <asp:CheckBox ID="SerializeIsAddZero" runat="server" Text="补零"></asp:CheckBox>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  ...
                  <td colspan="3">
                    ...
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=UrlInclude.ClientID%>'), '*');" title="遇到变动字符用*代替">&nbsp;
                      <font color="#0000FF">*</font>&nbsp;</a>
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=UrlInclude.ClientID%>'), '|');"
                      title="多个条件用|分隔各字符串">&nbsp;
                      <font color="#0000FF">|</font>&nbsp;</a>
                    <br>
              ...
              <table class="table noborder table-hover">
                <tr>
                  ...
                  <td>
                    ...
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentTitleStart.ClientID%>'), '*');" title="遇到变动字符用*代替">&nbsp;
                      <font color="#0000FF">*</font>
                    </a>
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentTitleStart.ClientID%>'), '|');"
                      title="多个条件用|分隔各字符串">&nbsp;
                      <font color="#0000FF">|</font>
                    </a>
                  </td>
                  ...
                  <td>
                    ...
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentTitleEnd.ClientID%>'), '*');" title="遇到变动字符用*代替">&nbsp;
                      <font color="#0000FF">*</font>
                    </a>
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentTitleEnd.ClientID%>'), '|');"
                      title="多个条件用|分隔各字符串">&nbsp;
                      <font color="#0000FF">|</font>
                    </a>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentContentStart.ClientID%>'), '*');" title="遇到变动字符用*代替">&nbsp;
                      <font color="#0000FF">*</font>
                    </a>
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentContentStart.ClientID%>'), '|');"
                      title="多个条件用|分隔各字符串">&nbsp;
                      <font color="#0000FF">|</font>
                    </a>
                  </td>
                  ...
                  <td>
                    ...
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentContentEnd.ClientID%>'), '*');" title="遇到变动字符用*代替">&nbsp;
                      <font color="#0000FF">*</font>
                    </a>
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentContentEnd.ClientID%>'), '|');"
                      title="多个条件用|分隔各字符串">&nbsp;
                      <font color="#0000FF">|</font>
                    </a>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentContentStart2.ClientID%>'), '*');" title="遇到变动字符用*代替">&nbsp;
                      <font color="#0000FF">*</font>
                    </a>
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentContentStart2.ClientID%>'), '|');"
                      title="多个条件用|分隔各字符串">&nbsp;
                      <font color="#0000FF">|</font>
                    </a>
                  </td>
                  ...
                  <td>
                    ...
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentContentEnd2.ClientID%>'), '*');" title="遇到变动字符用*代替">&nbsp;
                      <font color="#0000FF">*</font>
                    </a>
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentContentEnd2.ClientID%>'), '|');"
                      title="多个条件用|分隔各字符串">&nbsp;
                      <font color="#0000FF">|</font>
                    </a>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentContentStart3.ClientID%>'), '*');" title="遇到变动字符用*代替">&nbsp;
                      <font color="#0000FF">*</font>
                    </a>
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentContentStart3.ClientID%>'), '|');"
                      title="多个条件用|分隔各字符串">&nbsp;
                      <font color="#0000FF">|</font>
                    </a>
                  </td>
                  ...
                  <td>
                    ...
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentContentEnd3.ClientID%>'), '*');" title="遇到变动字符用*代替">&nbsp;
                      <font color="#0000FF">*</font>
                    </a>
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentContentEnd3.ClientID%>'), '|');"
                      title="多个条件用|分隔各字符串">&nbsp;
                      <font color="#0000FF">|</font>
                    </a>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentNextPageStart.ClientID%>'), '*');" title="遇到变动字符用*代替">&nbsp;
                      <font color="#0000FF">*</font>
                    </a>
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentNextPageStart.ClientID%>'), '|');"
                      title="多个条件用|分隔各字符串">&nbsp;
                      <font color="#0000FF">|</font>
                    </a>
                  </td>
                  ...
                  <td>
                    ...
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentNextPageEnd.ClientID%>'), '*');" title="遇到变动字符用*代替">&nbsp;
                      <font color="#0000FF">*</font>
                    </a>
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentNextPageEnd.ClientID%>'), '|');"
                      title="多个条件用|分隔各字符串">&nbsp;
                      <font color="#0000FF">|</font>
                    </a>
                  </td>
              ...
              <table class="table noborder table-hover">
                <tr>
                  ...
                  <td>
                    ...
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=TitleInclude.ClientID%>'), '*');" title="遇到变动字符用*代替">&nbsp;
                      <font color="#0000FF">*</font>&nbsp;</a>
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=TitleInclude.ClientID%>'), '|');"
                      title="多个条件用|分隔各字符串">&nbsp;
                      <font color="#0000FF">|</font>&nbsp;</a>
                    <br>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ListAreaStart.ClientID%>'), '*');" title="遇到变动字符用*代替">&nbsp;
                      <font color="#0000FF">*</font>
                    </a>
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ListAreaStart.ClientID%>'), '|');"
                      title="多个条件用|分隔各字符串">&nbsp;
                      <font color="#0000FF">|</font>
                    </a>
                  </td>
                  ...
                  <td>
                    ...
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ListAreaEnd.ClientID%>'), '*');" title="遇到变动字符用*代替">&nbsp;
                      <font color="#0000FF">*</font>
                    </a>
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ListAreaEnd.ClientID%>'), '|');"
                      title="多个条件用|分隔各字符串">&nbsp;
                      <font color="#0000FF">|</font>
                    </a>
                  </td>
                ...
                <tr>
                  ...
                  <td colspan="3">
                    ...
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentExclude.ClientID%>'), '*');" title="遇到变动字符用*代替">&nbsp;
                      <font color="#0000FF">*</font>
                    </a>
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentExclude.ClientID%>'), '|');"
                      title="多个条件用|分隔各字符串">&nbsp;
                      <font color="#0000FF">|</font>
                    </a>
                    <br>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentChannelStart.ClientID%>'), '*');" title="遇到变动字符用*代替">&nbsp;
                      <font color="#0000FF">*</font>
                    </a>
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentChannelStart.ClientID%>'), '|');"
                      title="多个条件用|分隔各字符串">&nbsp;
                      <font color="#0000FF">|</font>
                    </a>
                  </td>
                  ...
                  <td>
                    ...
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentChannelEnd.ClientID%>'), '*');" title="遇到变动字符用*代替">&nbsp;
                      <font color="#0000FF">*</font>
                    </a>
                    <a href="javascript:;" onclick="AddOnPos(document.getElementById('<%=ContentChannelEnd.ClientID%>'), '|');"
                      title="多个条件用|分隔各字符串">&nbsp;
                      <font color="#0000FF">|</font>
                    </a>
                  </td>
                ...
                <tr>
                  ...
                  <td colspan="3">
                    <asp:CheckBoxList ID="ContentAttributes" AutoPostBack="true" OnSelectedIndexChanged="ContentAttributes_SelectedIndexChanged"
                      RepeatColumns="8" RepeatDirection="Horizontal" class="checkboxlist" runat="server"></asp:CheckBoxList>
                  </td>
                </tr>
                  ...
                  <ItemTemplate>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="javascript:;" onclick="AddOnPos(this.parentNode.firstChild, '*');" title="遇到变动字符用*代替">&nbsp;
                          <font color="#0000FF">*</font>
                        </a>
                        <a href="javascript:;" onclick="AddOnPos(this.parentNode.firstChild, '|');" title="多个条件用|分隔各字符串">&nbsp;
                          <font color="#0000FF">|</font>
                        </a>
                      </td>
                      <td>
