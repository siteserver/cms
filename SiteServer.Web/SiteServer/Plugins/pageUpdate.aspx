    ...
    <script type="text/javascript">
      ...
      var $vue = new Vue({
        ...
        methods: {
          ...
          download: function () {
            ...
            for (var i = 0; i < this.packages.length; i++) {
              if (this.downloadIds.indexOf(this.packages[i].id) == -1 && this.checkedIds.indexOf(this.packages[i]
                ...
                this.downloadThePlugin(this.packages[i].id, this.packages[i].version)
                return;
              }
            }
          ...
          downloadThePlugin: function (packageId, version) {
            var $this = this;
          ...
          update: function () {
            ...
            for (var i = 0; i < this.packages.length; i++) {
              if (this.updatedIds.indexOf(this.packages[i].id) == -1 && this.checkedIds.indexOf(this.packages[i].id) !==
                ...
                this.updateThePlugin(this.packages[i].id, this.packages[i].version)
                return;
              }
            }
          ...
          updateThePlugin: function (packageId, version) {
            var $this = this;
