<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.Plugins.PageResumeContent" %>
...
<form class="form-inline" runat="server">
  ...
  <ul class="breadcrumb breadcrumb-button">
    <asp:Button class="btn" id="BtnSetIsView" Text="标记为已读" runat="server" />
    <asp:Button class="btn" id="BtnSetNotView" Text="标记为未读" runat="server" />
	<asp:Button class="btn" id="BtnDelete" Text="删 除" runat="server" />
	<asp:Button class="btn" id="BtnReturn" OnClick="Return_OnClick" Text="返 回" runat="server" />
  </ul>
