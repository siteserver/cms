<%@ Page Language="C#" ValidateRequest="false" Inherits="SiteServer.BackgroundPages.Plugins.PageGatherFileRuleAdd" %>
              ...
              <table class="table noborder table-hover">
                ...
                <asp:PlaceHolder ID="PlaceHolder_File" runat="server">
                  ...
                  <tr>
                    <td>下载相关文件：</td>
                    <td>
                      <asp:RadioButtonList ID="IsSaveRelatedFiles" AutoPostBack="true" OnSelectedIndexChanged="DropDownList_SelectedIndexChanged"
                        RepeatDirection="Horizontal" class="radiobuttonlist" runat="server">
                        <asp:ListItem Value="True">是</asp:ListItem>
                        <asp:ListItem Value="False" Selected="true">否</asp:ListItem>
                      </asp:RadioButtonList>
