...
group by tmp.userName";
        ...
        public string GetStlSqlStringCheckedBySearch(int startNum, int totalNum, string orderByString, string whereString)
        {
            ...
            return DatabaseUtils.GetPageSqlString(TableName, TranslateUtils.ObjectCollectionToString(ContentAttribute.AllAttributes.Value), sqlWhereString, orderByString, startNum - 1, totalNum);
        }
