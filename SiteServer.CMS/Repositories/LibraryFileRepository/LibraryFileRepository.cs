...
namespace SiteServer.CMS.Repositories
{
    public class LibraryFileRepository : ILibraryFileRepository
    {
        ...
        {
            _repository = new Repository<LibraryFile>(new Database(WebConfigUtils.DatabaseType, WebConfigUtils.ConnectionString), new Redis(WebConfigUtils.RedisConnectionString));
        }
