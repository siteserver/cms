...
namespace SiteServer.CMS.Repositories
{
    public class LibraryImageRepository : ILibraryImageRepository
    {
        ...
        {
            _repository = new Repository<LibraryImage>(new Database(WebConfigUtils.DatabaseType, WebConfigUtils.ConnectionString), new Redis(WebConfigUtils.RedisConnectionString));
        }
