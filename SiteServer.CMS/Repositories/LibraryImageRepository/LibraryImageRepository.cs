...
namespace SiteServer.CMS.Repositories
{
    public class LibraryImageRepository : ILibraryImageRepository
    {
        ...
        public LibraryImageRepository()
        {
            _repository = new Repository<LibraryImage>(new Database(WebConfigUtils.DatabaseType, WebConfigUtils.ConnectionString), CacheManager.Cache);
        }
        ...
        public async Task<IEnumerable<LibraryImage>> GetAllAsync(int groupId, string keyword, int page, int perPage)
        {
            var query = Q
