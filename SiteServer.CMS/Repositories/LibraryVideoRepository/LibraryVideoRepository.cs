...
namespace SiteServer.CMS.Repositories
{
    public class LibraryVideoRepository : ILibraryVideoRepository
    {
        ...
        public LibraryVideoRepository()
        {
            _repository = new Repository<LibraryVideo>(new Database(WebConfigUtils.DatabaseType, WebConfigUtils.ConnectionString), new Redis(WebConfigUtils.RedisConnectionString));
        }
