...
namespace SiteServer.CMS.Repositories
{
    public partial class TableStyleRepository
    {
        ...
        public Dictionary<string, object> GetDefaultAttributes(List<TableStyle> styleList)
        {
            ...
            foreach (var style in styleList)
            {
                ...
                else if (style.Items != null)
                {
                    var defaultValues = new List<string>();
                    foreach (var styleItem in style.Items)
                    {
                        if (styleItem.Selected)
                        {
                            defaultValues.Add(styleItem.Value);
                        }
                    }
