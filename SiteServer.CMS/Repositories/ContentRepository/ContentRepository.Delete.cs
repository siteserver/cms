...
namespace SiteServer.CMS.Repositories
{
    public partial class ContentRepository
    {
        ...
        public async Task RecycleContentsAsync(Site site, Channel channel, int adminId)
        {
            var contentIds = await GetContentIdsAsync(site, channel);
            await RecycleContentsAsync(site, channel, contentIds, adminId);
        }
        ...
        {
            var cacheKeys = new List<string>();
            var tableNames = await DataProvider.SiteRepository.GetTableNamesAsync(site);
