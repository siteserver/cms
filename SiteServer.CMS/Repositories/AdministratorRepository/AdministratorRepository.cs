...
namespace SiteServer.CMS.Repositories
{
    public partial class AdministratorRepository : IRepository
    {
        ...
        public async Task<int> GetCountAsync(string creatorUserName, string role, int lastActivityDate, string keyword)
        {
            ...
            {
                var userNameList = await DataProvider.AdministratorsInRolesRepository.GetUsersInRoleAsync(role);
        ...
        public async Task<(bool IsValid, string ErrorMessage)> InsertAsync(Administrator administrator, string password)
        {
            ...
            try
            {
                ...
                await DataProvider.AdministratorsInRolesRepository.AddUserToRolesAsync(administrator.UserName, roles);
