...
namespace SiteServer.CMS.Caches
{
    public static class TableStyleManager
    {
        ...
        public static List<TableStyleInfo> GetStyleInfoList(string tableName, List<int> relatedIdentities)
        {
            ...
            if (tableName == DataProvider.User.TableName || tableName == DataProvider.Channel.TableName || tableName == DataProvider.Site.TableName)
            {
        ...
        public static List<TableStyleInfo> GetSiteStyleInfoList(int siteId)
        {
            ...
            return GetStyleInfoList(DataProvider.Site.TableName, relatedIdentities);
        }
        ...
        public static List<TableStyleInfo> GetChannelStyleInfoList(ChannelInfo channelInfo)
        {
            ...
            return GetStyleInfoList(DataProvider.Channel.TableName, relatedIdentities);
        }
        ...
        public static List<TableStyleInfo> GetUserStyleInfoList()
        {
            ...
            return GetStyleInfoList(DataProvider.User.TableName, relatedIdentities);
        }
        ...
        private static TableStyleInfo GetDefaultContentTableStyleInfo(string tableName, string attributeName)
        {
            ...
            if (StringUtils.EqualsIgnoreCase(attributeName, ContentAttribute.Title))
            {
                styleInfo.AttributeName = ContentAttribute.Title;
            ...
            {
                styleInfo.AttributeName = ContentAttribute.VideoUrl;
            ...
            {
                styleInfo.AttributeName = ContentAttribute.FileUrl;
            ...
            {
                styleInfo.AttributeName = ContentAttribute.Content;
            ...
            {
                styleInfo.AttributeName = ContentAttribute.Summary;
