...
namespace SiteServer.CMS.Caches
{
    public static class AdminManager
    {
        private static class AdminManagerCache
        {
            ...
            public static AdministratorInfo GetCacheByUserId(int userId)
            {
                ...
                lock (LockObject)
                {
                    ...
                    if (adminInfo == null)
                    {
                        adminInfo = DataProvider.Administrator.GetByUserId(userId);
                        if (adminInfo != null)
                        {
                            dict[GetDictKeyByUserId(adminInfo.Id)] = adminInfo;
                            dict[GetDictKeyByUserName(adminInfo.UserName)] = adminInfo;
            ...
            public static AdministratorInfo GetCacheByUserName(string userName)
            {
                ...
                lock (LockObject)
                {
                    ...
                    if (adminInfo == null)
                    {
                        adminInfo = DataProvider.Administrator.GetByUserName(userName);
                        if (adminInfo != null)
                        {
                            dict[GetDictKeyByUserId(adminInfo.Id)] = adminInfo;
                            dict[GetDictKeyByUserName(adminInfo.UserName)] = adminInfo;
            ...
            public static AdministratorInfo GetCacheByMobile(string mobile)
            {
                ...
                lock (LockObject)
                {
                    ...
                    if (adminInfo == null)
                    {
                        adminInfo = DataProvider.Administrator.GetByMobile(mobile);
                        if (adminInfo != null)
                        {
                            dict[GetDictKeyByUserId(adminInfo.Id)] = adminInfo;
                            dict[GetDictKeyByUserName(adminInfo.UserName)] = adminInfo;
            ...
            public static AdministratorInfo GetCacheByEmail(string email)
            {
                ...
                lock (LockObject)
                {
                    ...
                    if (adminInfo == null)
                    {
                        adminInfo = DataProvider.Administrator.GetByEmail(email);
                        if (adminInfo != null)
                        {
                            dict[GetDictKeyByUserId(adminInfo.Id)] = adminInfo;
                            dict[GetDictKeyByUserName(adminInfo.UserName)] = adminInfo;
        ...
        public static string GetRoleNames(string userName)
        {
            ...
            var roles = DataProvider.AdministratorsInRoles.GetRolesForUser(userName);
