    ...
    public static class StlChannelCache
    {
        ...
        public static int GetSiteId(int channelId)
        {
            ...
            lock (LockObject)
            {
                ...
                if (retval == -1)
                {
                    retval = DataProvider.Channel.GetSiteId(channelId);
        ...
        public static DataSet GetStlDataSourceBySiteId(int siteId, int startNum, int totalNum, string whereString, string orderByString)
        {
            ...
            lock (LockObject)
            {
                ...
                if (retval == null)
                {
                    retval = DataProvider.Channel.GetStlDataSourceBySiteId(siteId, startNum, totalNum, whereString, orderByString);
                    StlCacheManager.Set(cacheKey, retval);
                }
            }
        ...
        //        if (retval == -1)
        //        {
        //            retval = DataProvider.Channel.GetIdByIndexName(siteId, channelIndex);
        //            StlCacheManager.Set(cacheKey, retval);
        //        }
        //    }
        ...
        public static int GetIdByParentIdAndTaxis(int parentId, int taxis, bool isNextChannel)
        {
            ...
            lock (LockObject)
            {
                ...
                if (retval == -1)
                {
                    retval = DataProvider.Channel.GetIdByParentIdAndTaxis(parentId, taxis, isNextChannel);
                    StlCacheManager.Set(cacheKey, retval);
                }
            }
        ...
        public static string GetWhereString(int siteId, string groupContent, string groupContentNot, bool isImageExists, bool isImage, string where)
        {
            ...
            lock (LockObject)
            {
                ...
                if (retval == null)
                {
                    retval = DataProvider.Channel.GetWhereString(groupContent, groupContentNot,
        ...
        public static List<int> GetIdListByTotalNum(List<int> channelIdList, int totalNum, string orderByString, string whereString)
        {
            ...
            lock (LockObject)
            {
                ...
                if (retval == null)
                {
                    retval = DataProvider.Channel.GetIdListByTotalNum(channelIdList, totalNum, orderByString, whereString);
                    StlCacheManager.Set(cacheKey, retval);
                }
            }
        ...
        public static ChannelInfo GetChannelInfoByLastAddDate(int channelId)
        {
            ...
            lock (LockObject)
            {
                ...
                if (retval == null)
                {
                    retval = DataProvider.Channel.GetChannelInfoByLastAddDate(channelId);
                    StlCacheManager.Set(cacheKey, retval);
                }
            }
        ...
        public static ChannelInfo GetChannelInfoByTaxis(int channelId)
        {
            ...
            lock (LockObject)
            {
                ...
                if (retval == null)
                {
                    retval = DataProvider.Channel.GetChannelInfoByTaxis(channelId);
                    StlCacheManager.Set(cacheKey, retval);
                }
            }
