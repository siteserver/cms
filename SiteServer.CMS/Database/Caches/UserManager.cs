...
namespace SiteServer.CMS.Database.Caches
{
    public static class UserManager
    {
        private static class UserManagerCache
        {
            ...
            public static UserInfo GetCacheByUserId(int userId)
            {
                ...
                lock (LockObject)
                {
                    ...
                    if (userInfo == null)
                    {
                        userInfo = DataProvider.User.GetByUserId(userId);
                        if (userInfo != null)
                        {
                            dict[GetDictKeyByUserId(userInfo.Id)] = userInfo;
                            dict[GetDictKeyByUserName(userInfo.UserName)] = userInfo;
            ...
            public static UserInfo GetCacheByUserName(string userName)
            {
                ...
                lock (LockObject)
                {
                    ...
                    if (userInfo == null)
                    {
                        userInfo = DataProvider.User.GetByUserName(userName);
                        if (userInfo != null)
                        {
                            dict[GetDictKeyByUserId(userInfo.Id)] = userInfo;
                            dict[GetDictKeyByUserName(userInfo.UserName)] = userInfo;
            ...
            public static UserInfo GetCacheByMobile(string mobile)
            {
                ...
                lock (LockObject)
                {
                    ...
                    if (userInfo == null)
                    {
                        userInfo = DataProvider.User.GetByMobile(mobile);
                        if (userInfo != null)
                        {
                            dict[GetDictKeyByUserId(userInfo.Id)] = userInfo;
                            dict[GetDictKeyByUserName(userInfo.UserName)] = userInfo;
            ...
            public static UserInfo GetCacheByEmail(string email)
            {
                ...
                lock (LockObject)
                {
                    ...
                    if (userInfo == null)
                    {
                        userInfo = DataProvider.User.GetByEmail(email);
                        if (userInfo != null)
                        {
                            dict[GetDictKeyByUserId(userInfo.Id)] = userInfo;
                            dict[GetDictKeyByUserName(userInfo.UserName)] = userInfo;
        ...
        {
            if (ConfigManager.Instance.SystemExtend.UserRegistrationMinMinutes == 0 || string.IsNullOrEmpty(ipAddress))
            {
                return true;
            }
        ...
        public static void CacheIpAddress(string ipAddress)
        {
            if (ConfigManager.Instance.SystemExtend.UserRegistrationMinMinutes > 0 && !string.IsNullOrEmpty(ipAddress))
            {
                CacheUtils.InsertMinutes($"SiteServer.CMS.Provider.User.InsertObject.IpAddress.{ipAddress}", ipAddress, ConfigManager.Instance.SystemExtend.UserRegistrationMinMinutes);
            }
        }
