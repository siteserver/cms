...
namespace SiteServer.CMS.Database.Extends
{
    ...
    {
        private readonly TableStyleInfo _tableStyleInfo;

        public TableStyleInfoExtend(TableStyleInfo tableStyleInfo) : base(tableStyleInfo.GetExtendValues())
        {
            _tableStyleInfo = tableStyleInfo;
        }

        public override void Set(string name, object value)
        {
            base.Set(name, value);
            _tableStyleInfo?.SetExtendValues(ToString());
        }
