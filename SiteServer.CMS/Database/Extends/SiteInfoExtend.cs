...
namespace SiteServer.CMS.Database.Extends
{
    public class SiteInfoExtend : AttributesImpl
    {
        ...
        public SiteInfoExtend(SiteInfo siteInfo) : base(siteInfo.GetSettingsXml())
        {
            _siteInfo = siteInfo;
        }
        ...
        {
            base.Set(name, value);
            _siteInfo?.SetSettingsXml(ToString());
        }
        ...
        public string WebUrl => IsSeparatedWeb ? SeparatedWebUrl : PageUtils.ParseNavigationUrl($"~/{_siteInfo.SiteDir}");
