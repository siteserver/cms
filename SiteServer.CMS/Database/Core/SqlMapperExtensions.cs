...
namespace SiteServer.CMS.Database.Core
{
    ...
    public static partial class SqlMapperExtensions
    {
        ...
        private static List<PropertyInfo> TypePropertiesCache(Type type)
        {
            ...
            var properties = ReflectionUtils.GetAllInstancePropertyInfos(type).Where(IsWriteable).ToArray();
        ...
        public static long Insert<T>(this IDbConnection connection, T entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            foreach (var property in allPropertiesExceptKeyAndComputed)
            {
                var value = ReflectionUtils.GetValue(entityToInsert, property.Name);
                dbParameters.Add(property.Name, value);
            }
            ...
            if (!isList)    //single entity
            {
                returnVal = adapter.Insert(connection, transaction, commandTimeout, name, sbColumnList.ToString(),
                    sbParameterList.ToString(), keyProperties, dbParameters);
            }
            else
            {
                //insert list of entities
                var cmd = $"insert into {name} ({sbColumnList}) values ({sbParameterList})";
                returnVal = connection.Execute(cmd, dbParameters, transaction, commandTimeout);
            }
        ...
        private static class ProxyGenerator
        {
            ...
            public static T GetInterfaceProxy<T>()
            {
                ...
                foreach (var property in ReflectionUtils.GetAllInstancePropertyInfos(typeof(T)))
                {
...
public partial interface ISqlAdapter
{
    ...
    int Insert(IDbConnection connection, IDbTransaction transaction, int? commandTimeout, string tableName, string columnList, string parameterList, IEnumerable<PropertyInfo> keyProperties, DynamicParameters entityToInsert);
...
public partial class SqlServerAdapter : ISqlAdapter
{
    ...
    /// <param name="entityToInsert">The entity to insert.</param>
    /// <returns>The Id of the row created.</returns>
    public int Insert(IDbConnection connection, IDbTransaction transaction, int? commandTimeout, string tableName, string columnList, string parameterList, IEnumerable<PropertyInfo> keyProperties, DynamicParameters entityToInsert)
    {
