...
namespace SiteServer.CMS.Model
{
    ...
    public class Channel : Entity, IChannel
    {
        ...
        {
            get => TranslateUtils.StringCollectionToStringList(ContentRelatedPluginIds);
            set => ContentRelatedPluginIds = string.Join(",", value);
        }
        ...
        {
            get => TranslateUtils.StringCollectionToStringList(GroupNameCollection);
            set => GroupNameCollection = string.Join(",", value);
        }
