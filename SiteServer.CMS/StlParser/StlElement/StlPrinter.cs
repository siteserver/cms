...
namespace SiteServer.CMS.StlParser.StlElement
{
    ...
    public class StlPrinter
	{
        ...
        {
            var jsUrl = SiteFilesAssets.GetUrl(pageInfo.ApiUrl, pageInfo.TemplateInfo.FileCharset == ECharset.gb2312 ? SiteFilesAssets.Print.JsGb2312 : SiteFilesAssets.Print.JsUtf8);
