...
namespace SiteServer.CMS.WeiXin.Provider
{
    public class MapDao : DataProviderBase
    {
        ...
        public int Insert(MapInfo mapInfo)
        {
            ...
            var sqlInsert = BaiRongDataProvider.DatabaseDao.GetInsertSqlString(mapInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms = null;
            var sqlUpdate = BaiRongDataProvider.DatabaseDao.GetUpdateSqlString(mapInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        public string GetTitle(int mapId)
        {
            ...
            string sqlWhere = $"WHERE ID = {mapId}";
            var sqlSelect = BaiRongDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, MapAttribute.Title, sqlWhere, null);
