...
namespace SiteServer.CMS.WeiXin.Provider
{
    public class LotteryDao : DataProviderBase
    {
        ...
        public int Insert(LotteryInfo lotteryInfo)
        {
            ...
            var sqlInsert = BaiRongDataProvider.DatabaseDao.GetInsertSqlString(lotteryInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms = null;
            var sqlUpdate = BaiRongDataProvider.DatabaseDao.GetUpdateSqlString(lotteryInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        public List<int> GetLotteryIdList(int publishmentSystemId, ELotteryType lotteryType)
        {
            ...
            var sqlSelect = BaiRongDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, LotteryAttribute.Id, sqlWhere, null);
        ...
        public int GetKeywordId(int lotteryId)
        {
            ...
            string sqlWhere = $"WHERE ID = {lotteryId}";
            var sqlSelect = BaiRongDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, LotteryAttribute.KeywordId, sqlWhere, null);
