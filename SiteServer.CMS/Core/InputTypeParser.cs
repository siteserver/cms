...
//            value = ContentUtility.TextEditorContentDecode(value, publishmentSystemInfo);
...
//            {
//                theValue = ContentUtility.TextEditorContentEncode(theValue, publishmentSystemInfo);
//            }
...
//            if (inputType == InputType.TextEditor)
//            {
//                theValue = ContentUtility.TextEditorContentEncode(theValue, publishmentSystemInfo, isSaveImage && publishmentSystemInfo.Additional.IsSaveImageInTextEditor);
//                theValue = ETextEditorTypeUtils.TranslateToStlElement(theValue);
//            }
