...
namespace SiteServer.CMS.Core
{
    public class StringUtility
    {
        ...
        /// <param name="isLocal">是否是后台请求</param>
        /// <returns></returns>
        public static string TextEditorContentDecode(string content, PublishmentSystemInfo publishmentSystemInfo, bool isLocal)
        {
            var publishmentSystemUrl = publishmentSystemInfo != null ? publishmentSystemInfo.Additional.WebUrl : PageUtils.ApplicationPath;
            return TextEditorContentDecode(content, publishmentSystemUrl, isLocal);
        }
        ...
        public static string TextEditorContentDecode(string content, string publishmentSystemUrl, bool isLocal)
        {
            var builder = new StringBuilder(content);
            ...
            //if (!isLocal && !string.IsNullOrEmpty(editorUploadFilePre))
            //{
