<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.WeiXin.ModalAlbumContentPhotoUpload"%>
  ...
  <script type="text/javascript" src="../../sitefiles/bairong/scripts/swfUpload/handlers.js"></script>
	...
	<div id="Photo_0" style="display:none">
        ...
        <div class="pull-left" style="margin:10px;">
            ...
            <input id="imgTitle_0" name="imgTitle_0" type="text" placeholder="图片描述(仅限10字)" maxlength="10"></div>
            <div class="center">
	...
	<script type="text/javascript">
	    ...
	    function add_form(id, url, smallUrl,largeUrl,title){
	        var $count = $('#Photo_Count');
