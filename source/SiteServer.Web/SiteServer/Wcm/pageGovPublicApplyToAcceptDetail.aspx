<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.Wcm.PageGovPublicApplyToAcceptDetail" %>
...
<form class="form-inline" runat="server">
  ...
  <div class="popover popover-static">
    <h3 class="popover-title">待受理申请</h3>
    <div class="popover-content">
    
      <div class="applyTitle">
        <asp:Literal ID="ltlName" runat="server"></asp:Literal>
        向 <%=ApplyDepartment%> 发出依申请公开请求【<asp:Literal ID="ltlState" runat="server"></asp:Literal>】</div>
      ...
      <table id="divAccept" class="table table-bordered action" style="display:none">
        <tr class="info thead">
          <td colspan="2"><strong>受理申请</strong></td>
        </tr>
        <tr>
          <td>
      ...
      <table id="divDeny" class="table table-bordered action" style="display:none">
        <tr class="info thead">
          <td colspan="2"><strong>拒绝申请</strong></td>
        </tr>
        <tr>
          <td>
            <table class="table table-noborder">
              <tr>
                <td colspan="2"><div class="tips">拒绝申请后信息将变为拒绝受理状态</div></td>
              </tr>
              <tr>
      ...
      <table id="divReply" class="table table-bordered action" style="display:none">
        ...
        <tr>
          <td>
            <table class="table table-noborder">
              <tr>
                <td colspan="2"><div class="tips">办理申请后信息将变为待审核状态</div></td>
              </tr>
              <tr>
      ...
      <table id="divSwitchTo" class="table table-bordered action" style="display:none">
        ...
        <tr>
          <td>
            <table class="table table-noborder">
              <tr>
                <td colspan="2"><div class="tips">注意：转办申请后信息状态仍为待受理状态，需要转办部门进行受理</div></td>
              </tr>
