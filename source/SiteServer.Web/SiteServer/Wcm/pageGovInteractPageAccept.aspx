<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.Wcm.PageGovInteractPageAccept" %>
...
<form class="form-inline" runat="server">
  ...
  <div class="popover popover-static">
    <h3 class="popover-title">待受理办件</h3>
    <div class="popover-content">
              ...
              <tr>
                <td><table class="applyTable" border=0 cellspacing=0 cellpadding=0 style="width:100%;height:100%;table-layout:fixed">
                    <tbody>
                      ...
                      <tr>
                        <td bgcolor="#f0f6fc" class="attribute">提交时间</td>
      ...
      <table width="100%" border="0" class="center" cellpadding="8" cellspacing="0">
        <asp:PlaceHolder ID="phRemarks" Visible="false" runat="server">
          <tr>
            ...
            <td><table border=0 cellspacing=0 cellpadding=0 class="applyTable" style="width:100%; border:1px solid silver">
                <tr>
        ...
        <tr>
          ...
          <td>
            <ul class="breadcrumb breadcrumb-button" style="text-align:left">
              ...
              <input type="button" value="受 理" onClick="showAction('divAccept');return false;" class="btn btn-success" />
              <input type="button" value="拒 绝" onClick="showAction('divDeny');return false;" class="btn" />
              </asp:PlaceHolder>
              ...
              <input type="button" value="转 移" onClick="showAction('divTranslate');return false;" class="btn" />
              </asp:PlaceHolder>
              <asp:PlaceHolder ID="phBtnReply" runat="server">
              <input type="button" value="直接办理" onClick="showAction('divReply');return false;" class="btn" />
              </asp:PlaceHolder>
      ...
      <table id="divAccept" class="table table-bordered action" style="display:none">
        <tr class="info thead">
          <td colspan="2"><strong>受理办件</strong></td>
        </tr>
        <tr>
          <td>
            <table class="table table-noborder">
              ...
              <tr>
                <td class="center">&nbsp;</td>
                <td><asp:Button class="btn btn-primary" OnClick="Accept_OnClick" Text="提 交" runat="server"></asp:Button>
                  &nbsp;&nbsp;
                  <input type="button" value="取 消" onClick="$('#divAccept').hide();" class="btn" /></td>
              </tr>
            </table>
          </td>
        </tr>
      ...
      <table id="divDeny" class="table table-bordered action" style="display:none">
        <tr class="info thead">
          <td colspan="2"><strong>拒绝办件</strong></td>
        </tr>
        <tr>
          <td>
            <table class="table noborder">
              <tr>
                <td colspan="2"><div class="tips">拒绝办件后信息将变为拒绝受理状态</div></td>
              </tr>
              <tr>
                <td class="center" width="120">拒绝理由：</td>
                <td><asp:TextBox ID="tbDenyReply" runat="server" TextMode="MultiLine" style="width:80%;height:120px;"></asp:TextBox></td>
              </tr>
              <tr>
                <td class="center">拒绝部门：</td>
                <td><%=MyDepartment%></td>
              </tr>
              <tr>
                <td class="center">拒绝人：</td>
                <td><%=MyDisplayName%></td>
              </tr>
              <tr>
                <td class="center">&nbsp;</td>
                <td><asp:Button class="btn btn-primary" OnClick="Deny_OnClick" Text="提 交" runat="server"></asp:Button>
                  &nbsp;&nbsp;
                  <input type="button" value="取 消" onClick="$('#divDeny').hide();" class="btn" /></td>
              </tr>
            </table>
          </td>
        </tr>
      ...
      <table id="divReply" class="table table-bordered action" style="display:none">
        <tr class="info thead">
          <td colspan="2"><strong>直接办理</strong></td>
        </tr>
        <tr>
          <td>
            <table class="table noborder">
      ...
      <table id="divSwitchTo" class="table table-bordered action" style="display:none">
        ...
        <tr>
          <td>
            <table class="table noborder">
              <tr>
                <td colspan="2"><div class="tips">注意：转办办件后信息状态仍为待受理状态，需要转办部门进行受理</div></td>
              </tr>
      ...
      <table id="divTranslate" class="table table-bordered action" style="display:none">
        <tr class="info thead">
          <td colspan="2"><strong>转移办件</strong></td>
        </tr>
        <tr>
          <td>
            <table class="table noborder">
              <tr>
                <td colspan="2"><div class="tips">注意：此操作将吧办件转移到对应的分类中</div></td>
              </tr>
              ...
              <tr>
                <td class="center">&nbsp;</td>
                <td><asp:Button class="btn btn-primary" OnClick="Translate_OnClick" Text="提 交" runat="server"></asp:Button>
                  &nbsp;&nbsp;
                  <input type="button" value="取 消" onClick="$('#divTranslate').hide();" class="btn" /></td>
              </tr>
            </table>
          </td>
        </tr>
