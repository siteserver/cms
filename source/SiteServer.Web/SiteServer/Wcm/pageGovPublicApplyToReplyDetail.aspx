<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.Wcm.PageGovPublicApplyToReplyDetail" %>
...
<form class="form-inline" runat="server">
  ...
  <div class="popover popover-static">
    <h3 class="popover-title">待办理申请</h3>
    <div class="popover-content">
      ...
      <div class="applyTitle">
        ...
        向
        <%=ApplyDepartment%>
        发出依申请公开请求【<asp:Literal ID="ltlState" runat="server"></asp:Literal>】
      </div>
      ...
      <table id="divReply" class="table table-bordered action" style="display:none">
        <tr class="info thead">
          <td colspan="2"><strong>办理申请</strong></td>
        </tr>
        <tr>
          <td>
