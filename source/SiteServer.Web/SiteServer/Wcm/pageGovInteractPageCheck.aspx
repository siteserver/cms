<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.Wcm.PageGovInteractPageCheck" %>
...
<form class="form-inline" runat="server">
  ...
  <div class="popover popover-static">
    <h3 class="popover-title">待审核办件</h3>
              ...
              <td><table class="applyTable" border="0" cellspacing="0" cellpadding="0" style="width:100%;height:100%;table-layout:fixed">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="tdBorder" width="300"><asp:Literal ID="ltlState" runat="server"></asp:Literal></td>
