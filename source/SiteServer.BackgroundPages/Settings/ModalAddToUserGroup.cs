...
namespace SiteServer.BackgroundPages.Settings
{
    public class ModalAddToUserGroup : BasePage
    {
        ...
        {
            return PageUtils.GetOpenWindowStringWithCheckBoxValue("设置用户类别", PageUtils.GetSettingsUrl(nameof(ModalAddToUserGroup), null), "UserIDCollection", "请选择需要设置类别的用户！", 400, 220);
        }
