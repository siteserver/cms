...
namespace SiteServer.BackgroundPages.Settings
{
    public class PageUserGroup : BasePage
    {
        ...
        {
            return PageUtils.GetSettingsUrl(nameof(PageUserGroup), null);
        }
        ...
        public void Page_Load(object sender, EventArgs e)
        {
			...
			if (!IsPostBack)
            {
                BreadCrumbSettings("用户组管理", AppManager.Permissions.Settings.UserManagement);
        ...
        public void MyDataGrid_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                {
                    var deleteUrl = PageUtils.GetSettingsUrl(nameof(PageUserGroup), new NameValueCollection
                    {
                        {"Delete", "True"},
