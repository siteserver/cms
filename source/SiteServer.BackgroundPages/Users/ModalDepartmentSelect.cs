	...
	public class ModalDepartmentSelect : BasePage
    {
	    ...
	    public static string GetShowPopWinString(int projectId)
	    {
	        return PageUtils.GetOpenWindowString("设置分类",
	            PageUtils.GetUsersUrl(nameof(ModalDepartmentSelect), new NameValueCollection
	            {
		...
		{
		    _additional.Add("UrlFormatString", PageUtils.GetUsersUrl(nameof(ModalDepartmentSelect), null));
