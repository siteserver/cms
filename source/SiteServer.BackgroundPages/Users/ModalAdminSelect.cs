...
namespace SiteServer.BackgroundPages.Users
{
	public class ModalAdminSelect : BasePage
    {
        ...
        {
            return PageUtils.GetOpenWindowString("管理员选择", PageUtils.GetUsersUrl(nameof(ModalAdminSelect), new NameValueCollection
            {
		...
		public void Page_Load(object sender, EventArgs e)
		{
		    ...
		    var url = PageUtils.GetUsersUrl(nameof(ModalAdminSelect), new NameValueCollection
            {
