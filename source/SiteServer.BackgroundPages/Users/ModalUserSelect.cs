...
namespace SiteServer.BackgroundPages.Users
{
    public class ModalUserSelect : BasePage
    {
        ...
        {
            return PageUtils.GetOpenWindowString("选择用户", PageUtils.GetUsersUrl(nameof(ModalUserSelect), new NameValueCollection
            {
                {"textBoxID", textBoxId}
            }));
        }
...
");
        ...
        private string PageUrl
        {
            get
            {
                ...
                {
                    _pageUrl = PageUtils.GetUsersUrl(nameof(ModalUserSelect), new NameValueCollection
                    {
