...
namespace SiteServer.BackgroundPages.Users
{
    public class PageDepartment : BasePage
    {
        ...
        public static string GetRedirectUrl(int currentDepartmentId)
        {
            ...
            {
                return PageUtils.GetUsersUrl(nameof(PageDepartment), new NameValueCollection
                {
                    {"CurrentDepartmentID", currentDepartmentId.ToString() }
                });
            }
            return PageUtils.GetUsersUrl(nameof(PageDepartment), null);
        }
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                BreadCrumbUsers("所属部门管理", AppManager.Permissions.Users.AdminConfiguration);
                ...
                Delete.Attributes.Add("onclick", PageUtils.GetRedirectStringWithCheckBoxValueAndAlert(PageUtils.GetUsersUrl(nameof(PageDepartment), new NameValueCollection
                {
                    {"Delete", "True" }
...
";
            ...
            else if (loadingType == EDepartmentLoadingType.ContentList)
            {
                ...
                var urlUp = PageUtils.GetUsersUrl(nameof(PageDepartment), new NameValueCollection
                {
                    {"Subtract", "True"},
                ...
                var urlDown = PageUtils.GetUsersUrl(nameof(PageDepartment), new NameValueCollection
                {
                    {"Add", "True"},
                    {"DepartmentID", departmentInfo.DepartmentId.ToString()}
                });
