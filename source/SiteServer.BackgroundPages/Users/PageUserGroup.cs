...
namespace SiteServer.BackgroundPages.Users
{
    public class PageUserGroup : BasePage
    {
        ...
        {
            return PageUtils.GetUsersUrl(nameof(PageUserGroup), null);
        }
        ...
        public void Page_Load(object sender, EventArgs e)
        {
			...
			if (!IsPostBack)
            {
                BreadCrumbUsers("用户组管理", AppManager.Permissions.Users.UserManagement);
        ...
        public void MyDataGrid_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                {
                    var deleteUrl = PageUtils.GetUsersUrl(nameof(PageUserGroup), new NameValueCollection
                    {
                        {"Delete", "True"},
