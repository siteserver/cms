    ...
    public class PageFlapAdd : BasePageCms
    {
		...
		public void Page_Load(object sender, EventArgs e)
        {
			...
			if (!IsPostBack)
            {
                ...
                BreadCrumb(AppManager.WeiXin.LeftMenu.IdFunction, AppManager.WeiXin.LeftMenu.Function.IdFlap, pageTitle, AppManager.WeiXin.Permission.WebSite.Flap);
                ...
                else if (selectedStep == 5)
                {
                    ...
                    try
                    {
                        if (_lotteryId > 0)
                        {
                            ...
                            LogUtils.AddAdminLog(Body.AdministratorName, "修改大翻牌", $"大翻牌:{TbTitle.Text}");
                        ...
                        else
                        {
                            ...
                            LogUtils.AddAdminLog(Body.AdministratorName, "添加大翻牌", $"大翻牌:{TbTitle.Text}");
