...
{
    public class BackgroundCardRechargeLog : BackgroundBasePageWX
    {
        ...
        {
            return PageUtils.GetWXUrl("background_cardRechargeLog.aspx?PublishmentSystemID=" + publishmentSystemID + "&cardSN=" + cardSN + "&userName=" + userName + "&mobile=" + mobile);
        }
            ...
            get
            {
                if (string.IsNullOrEmpty(_pageUrl))
                {
                    _pageUrl = PageUtils.GetWXUrl(
                        $"background_cardRechargeLog.aspx?PublishmentSystemID={PublishmentSystemID}&cardID={ddlCard.SelectedValue}&cardSN={tbCardSN.Text}&userName={tbUserName.Text}&mobile={tbMobile.Text}");
                }
                return _pageUrl;
            }
        }
