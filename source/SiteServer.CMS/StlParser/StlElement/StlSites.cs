...
namespace SiteServer.CMS.StlParser.StlElement
{
    ...
    {
        public const string ElementName = "stl:sites";//获取站点列表
        ...
        public const string Attribute_Where = "where";                      //获取站点列表的条件判断
        ...
        public static ListDictionary AttributeList
        {
            get
            {
                ...
                attributes.Add(Attribute_Where, "获取站点列表的条件判断");
        ...
        private static string ParseImpl(PageInfo pageInfo, ContextInfo contextInfo, ContentsDisplayInfo displayInfo)
        {
            ...
            var siteName = displayInfo.OtherAttributes[Attribute_SiteName];
            var directory = displayInfo.OtherAttributes[Attribute_Directory];
            var since = displayInfo.OtherAttributes[Attribute_Since];
