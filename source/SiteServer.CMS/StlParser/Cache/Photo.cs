...
namespace SiteServer.CMS.StlParser.Cache
{
    public class Photo
    {
        ...
        {
            var cacheKey = StlCacheUtils.GetCacheKeyByGuid(guid, nameof(Photo), nameof(GetPhotoInfoList),
        ...
        {
            var cacheKey = StlCacheUtils.GetCacheKeyByGuid(guid, nameof(Photo), nameof(GetFirstPhotoInfo),
                       publishmentSystemId.ToString(), contentId.ToString());
