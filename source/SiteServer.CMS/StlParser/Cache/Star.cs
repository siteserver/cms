...
namespace SiteServer.CMS.StlParser.Cache
{
    public class Star
    {
        ...
        {
            var cacheKey = StlCacheUtils.GetCacheKeyByGuid(guid, nameof(Star), nameof(GetCount), publishmentSystemId.ToString(), channelId.ToString(), contentId.ToString());
        ...
        {
            var cacheKey = StlCacheUtils.GetCacheKeyByGuid(guid, nameof(Star), nameof(GetContentIdListByPoint), publishmentSystemId.ToString());
