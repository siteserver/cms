...
namespace SiteServer.CMS.Model
{
    ...
    {
        public CreateTaskInfo(int id, string name, ECreateType createType, int publishmentSystemId, int channelId, int contentId, int templateId, int pageCount, string guid)
        {
            Id = id;
            Name = name;
