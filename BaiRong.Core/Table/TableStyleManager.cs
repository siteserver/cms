...
namespace BaiRong.Core.Table
{
    public sealed class TableStyleManager
    {
        ...
        {
            var tableStyleId = BaiRongDataProvider.TableStyleDao.Insert(styleInfo);
            IsChanged = true;
            return tableStyleId;
        }
        ...
        public static TableStyleInfo GetDefaultTableStyleInfo(string tableName, string attributeName)
        {
            ...
            var styleInfo = new TableStyleInfo(0, 0, tableName, attributeName, 0, attributeName, string.Empty, false, InputTypeUtils.GetValue(InputType.Text), string.Empty, true, string.Empty);
