...
<head>
  ...
  <script>
    ...
    $(document).ready(function() {
      editor = UE.getEditor("Content", {allowDivTransToP: false, maximumWords:99999999});
    });
    ...
    function autoCheckKeywords() {
      var pureText = editor.getContentTxt();
      var htmlContent = editor.getContent();
      $.post('<%=AjaxGetDetectionReplaceUrl%>&r=' + Math.random(),
      {content:pureText},
      function(data) {
        if(data) {
          keywords = data;
  ...
  <form id="myForm" class="m-l-15 m-r-15" enctype="multipart/form-data" runat="server">
    ...
    <div class="card-box">
      ...
      <div class="advanced" style="display: none">
        <div class="form-group form-row">
          <label class="col-1 col-form-label text-right text-truncate" title="属性">属性</label>
          <div class="col-5">
        ...
        <div class="form-group form-row">
          <label class="col-1 col-form-label text-right text-truncate" title="标签">标签</label>
          <div class="col-6">
        ...
        <asp:PlaceHolder ID="PhStatus" runat="server">
          <div class="form-group form-row">
            <label class="col-1 col-form-label text-right text-truncate" title="状态">状态</label>
            <div class="col-6">
        ...
        <div class="form-group form-row">
          <label class="col-1 col-form-label text-right text-truncate" title="外部链接">外部链接</label>
          <div class="col-6">
        ...
        <div class="form-group form-row">
          <label class="col-1 col-form-label text-right text-truncate" title="添加时间">添加时间</label>
          <div class="col-6">
        ...
        <asp:PlaceHolder ID="PhTranslate" runat="server">
          <div class="form-group form-row">
            <label class="col-1 col-form-label text-right text-truncate" title="转移到">转移到</label>
            <div class="col-10">
          ...
          <div class="form-group form-row" id="translateType" style="display: none">
            <label class="col-1 col-form-label text-right text-truncate" title="转移方式">转移方式</label>
            <div class="col-6">
