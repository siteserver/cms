...
<body>
  <form runat="server">
    ...
    <div class="form-inline form-row">
      ...
      <label class="col-1 col-form-label text-right rowSmallImageSize"> 宽 </label>
      <asp:TextBox ID="TbSmallImageWidth" class="form-control rowSmallImageSize" runat="server"></asp:TextBox>
      <label class="col-1 col-form-label text-right rowSmallImageSize"> 高 </label>
