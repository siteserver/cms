...
<body>
  <form class="m-l-15 m-r-15" runat="server">
    <div id="main" class="card-box">
      <h4 class="text-dark  header-title m-t-0"> SiteServer CMS <asp:Literal ID="LtlVersionInfo" runat="server"></asp:Literal>
        安装向导 </h4>
      <p class="text-muted m-b-25 font-13"> 欢迎来到SiteServer CMS 安装向导！只要进行以下几步操作，你就可以开始使用强大且可扩展的CMS系统了。 </p>
      ...
      <asp:PlaceHolder ID="PhStep1" runat="server">
        ...
        <div class="form-group">
          <label class="col-form-label"> SiteServer CMS 开源协议（GPL-3.0） <img src="../Pic/Installer/printerIcon.gif">
      ...
      <asp:PlaceHolder ID="PhStep2" runat="server">
        ...
        <div class="form-group">
          <label class="col-form-label"> 服务器信息 </label>
        ...
        <div class="form-group">
          <label class="col-form-label"> 目录权限检测 </label>
          <small class="form-text text-muted"> 系统要求必须满足下列所有的目录权限全部可读写的需求才能使用，如果没有相关权限请添加。 </small>
        </div>
        <div class="panel panel-default">
          <div class="panel-body p-0">
            <div class="table-responsive">
      ...
      <asp:PlaceHolder ID="PhStep3" runat="server">
        ...
        <div class="form-group">
          ...
          <small class="form-text text-muted"> 请选择需要安装的数据库类型。 </small>
        </div>
        <asp:PlaceHolder ID="PhSql1" runat="server">
          <div class="form-group">
            <label class="col-form-label"> 数据库主机
              <asp:RequiredFieldValidator ControlToValidate="TbSqlServer" errorMessage=" *" foreColor="red" Display="Dynamic"
                runat="server" />
            </label>
          ...
          <div class="form-group">
            <label class="col-form-label"> 数据库端口
              <asp:RequiredFieldValidator ControlToValidate="TbSqlServer" errorMessage=" *" foreColor="red" Display="Dynamic"
                runat="server" />
            </label>
          ...
          <asp:PlaceHolder id="PhSqlPort" runat="server">
            <div class="form-group">
              <label class="col-form-label"> 自定义端口
                <asp:RequiredFieldValidator ControlToValidate="TbSqlPort" errorMessage=" *" foreColor="red" Display="Dynamic"
                  runat="server" />
              </label>
              <asp:TextBox ID="TbSqlPort" class="form-control" runat="server" />
              <small class="form-text text-muted"> 连接数据库的端口 </small>
            </div>
          </asp:PlaceHolder>
          <div class="form-group">
            <label class="col-form-label"> 数据库用户名
              <asp:RequiredFieldValidator ControlToValidate="TbSqlUserName" errorMessage=" *" foreColor="red" Display="Dynamic"
                runat="server" />
            </label>
          ...
          <div class="form-group">
            <label class="col-form-label"> 数据库密码
              <asp:RequiredFieldValidator ControlToValidate="TbSqlPassword" errorMessage=" *" foreColor="red" Display="Dynamic"
                runat="server" />
          ...
          <asp:PlaceHolder id="PhSqlOracleDatabase" visible="false" runat="server">
            <div class="form-group">
              <label class="col-form-label"> 数据库名称
                <asp:RequiredFieldValidator ControlToValidate="TbSqlOracleDatabase" errorMessage=" *" foreColor="red"
                  Display="Dynamic" runat="server" />
              </label>
              <asp:TextBox ID="TbSqlOracleDatabase" class="form-control" runat="server" />
              <small class="form-text text-muted"> 指定需要安装的Oracle数据库名称 </small>
            </div>
          </asp:PlaceHolder>
        </asp:PlaceHolder>
        <asp:PlaceHolder ID="PhSql2" runat="server" Visible="false">
          <div class="form-group">
            <label class="col-form-label"> 选择数据库 </label>
            <asp:DropDownList ID="DdlSqlDatabaseName" class="form-control" runat="server"></asp:DropDownList>
            <small class="form-text text-muted"> 选择安装的数据库 </small>
          </div>
        </asp:PlaceHolder>
        <hr />
        <div class="text-center">
      ...
      <asp:PlaceHolder ID="PhStep4" runat="server">
        ...
        <div class="form-group">
          <label class="col-form-label"> 总管理员用户名
            <asp:RequiredFieldValidator ControlToValidate="TbAdminName" errorMessage=" *" foreColor="red" Display="Dynamic"
              runat="server" />
          </label>
          <asp:TextBox class="form-control" ID="TbAdminName" runat="server" />
          <small class="form-text text-muted"> 在此设置总管理员的登录用户名 </small>
        </div>
        <div class="form-group">
          <label class="col-form-label"> 总管理员密码
            <asp:RequiredFieldValidator ControlToValidate="TbAdminPassword" errorMessage=" *" foreColor="red" Display="Dynamic"
              runat="server" />
          </label>
          <asp:TextBox id="TbAdminPassword" TextMode="Password" onblur="checkPassword();" class="form-control" runat="server" />
          <small class="form-text text-muted"> 密码强度： <input type="text" id="passwordLevel" class="rank r0" disabled="disabled" />
          </small>
        </div>
        <div class="form-group">
          <label class="col-form-label"> 确认密码
            <asp:RequiredFieldValidator ControlToValidate="TbComfirmAdminPassword" errorMessage=" *" foreColor="red"
              Display="Dynamic" runat="server" />
            <asp:CompareValidator runat="server" ControlToCompare="TbAdminPassword" ControlToValidate="TbComfirmAdminPassword"
          ...
          <small class="form-text text-muted"> 6-16个字符，支持大小写字母、数字和符号 </small>
        </div>
        <div class="form-group">
          <label class="col-form-label"> 是否加密连接字符串 </label>
          <asp:DropDownList ID="DdlIsProtectData" class="form-control" runat="server"></asp:DropDownList>
          <small class="form-text text-muted"> 设置是否加密Web.Config中的数据库连接字符串 </small>
        </div>
        <hr />
        <div class="text-center">
          <asp:Button OnClick="BtnPrevious_Click" CausesValidation="false" class="btn" Text="上一步" runat="server"></asp:Button>
      ...
      <asp:PlaceHolder ID="PhStep5" runat="server">
        ...
        <div class="alert alert-success" role="alert">
          ...
          <p> 恭喜，您已经完成了 SiteServer CMS 的安装
