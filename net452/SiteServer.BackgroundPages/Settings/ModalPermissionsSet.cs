...
namespace SiteServer.BackgroundPages.Settings
{
    public class ModalPermissionsSet : BasePageCms
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            SystemWebUtils.SelectSingleItem(DdlPredefinedRole, EPredefinedRoleUtils.GetValue(type));
            ...
            SystemWebUtils.AddListItemsForSite(CblSiteId);
            SystemWebUtils.SelectMultiItems(CblSiteId, siteIdList);
        ...
        public void AddRole_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    var selectedRoles = SystemWebUtils.GetSelectedListControlValueArray(LbAvailableRoles);
        ...
        public void AddRoles_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                var roles = SystemWebUtils.GetListControlValues(LbAvailableRoles);
                if (roles.Length > 0)
                {
        ...
        public void DeleteRole_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    var selectedRoles = SystemWebUtils.GetSelectedListControlValueArray(LbAssignedRoles);
                    foreach (var selectedRole in selectedRoles)
                    {
        ...
        public void DeleteRoles_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                var roles = SystemWebUtils.GetListControlValues(LbAssignedRoles);
                if (roles.Length > 0)
                {
                    foreach (var role in roles)
                    {
            ...
            try
            {
                ...
                DataProvider.Administrator.UpdateSiteIdCollection(adminInfo,
                    EPredefinedRoleUtils.Equals(EPredefinedRole.SystemAdministrator, DdlPredefinedRole.SelectedValue)
                        ? SystemWebUtils.SelectedItemsValueToStringCollection(CblSiteId.Items)
                        : string.Empty);
