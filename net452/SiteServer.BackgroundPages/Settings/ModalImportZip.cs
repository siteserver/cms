...
namespace SiteServer.BackgroundPages.Settings
{
	public class ModalImportZip : BasePageCms
	{
		...
		public void Page_Load(object sender, EventArgs e)
        {
            ...
            SystemWebUtils.SelectSingleItemIgnoreCase(DdlImportType, true.ToString());
	    ...
	    private void ImportSiteTemplate(bool isUpload)
	    {
	        ...
	        else
	        {
	            ...
	            WebPageUtils.Redirect(ModalProgressBar.GetRedirectUrlStringWithSiteTemplateDownload(0, TbDownloadUrl.Text));
	        }
	    }
    }
}
