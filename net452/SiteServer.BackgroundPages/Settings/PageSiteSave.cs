...
namespace SiteServer.BackgroundPages.Settings
{
    public class PageSiteSave : BasePageCms
    {
        ...
        {
            return FxUtils.GetSettingsUrl(nameof(PageSiteSave), new NameValueCollection
            {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            SystemWebUtils.SelectSingleItemIgnoreCase(RblIsSaveAllFiles, true.ToString());
            ...
            SystemWebUtils.SelectSingleItemIgnoreCase(RblIsSaveContents, true.ToString());

            FxUtils.AddListItems(RblIsSaveAllChannels, "全部栏目", "指定栏目");
            SystemWebUtils.SelectSingleItemIgnoreCase(RblIsSaveAllChannels, true.ToString());
...
");
        ...
        private bool SaveFiles(out string errorMessage)
        {
            try
            {
                ...
                var lowerFileSystemArrayList = SystemWebUtils.GetSelectedListControlValueArrayList(CblDirectoriesAndFiles);
