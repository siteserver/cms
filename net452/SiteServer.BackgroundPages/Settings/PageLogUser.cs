...
namespace SiteServer.BackgroundPages.Settings
{
    public class PageLogUser : BasePage
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            BtnDelete.Attributes.Add("onclick", PageUtils.GetRedirectStringWithCheckBoxValueAndAlert(FxUtils.GetSettingsUrl(nameof(PageLogUser), new NameValueCollection
            {
                {"DeleteById", "True" }
            ...
            BtnDeleteAll.Attributes.Add("onclick",
                AlertUtils.ConfirmRedirect("删除所有日志", "此操作将删除所有日志信息，确定吗？", "删除全部",
                    FxUtils.GetSettingsUrl(nameof(PageLogUser), new NameValueCollection
                    {
                        {"DeleteAll", "True"}
                    })));
        ...
        {
            WebPageUtils.Redirect(FxUtils.GetSettingsUrl(nameof(PageLogUser), new NameValueCollection
            {
