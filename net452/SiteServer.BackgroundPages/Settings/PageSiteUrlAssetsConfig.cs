...
namespace SiteServer.BackgroundPages.Settings
{
	public class PageSiteUrlAssetsConfig : BasePageCms
    {
        ...
        {
            return FxUtils.GetSettingsUrl(nameof(PageSiteUrlAssetsConfig), new NameValueCollection
            {
                {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            SystemWebUtils.SelectSingleItem(RblIsSeparatedAssets, SiteInfo.IsSeparatedAssets.ToString());
        ...
        {
            WebPageUtils.Redirect(PageSiteUrlAssets.GetRedirectUrl());
        }
    }
}
