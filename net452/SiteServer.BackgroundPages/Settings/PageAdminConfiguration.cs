...
namespace SiteServer.BackgroundPages.Settings
{
    public class PageAdminConfiguration : BasePage
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            SystemWebUtils.SelectSingleItemIgnoreCase(DdlLoginPasswordRestriction, ConfigManager.Instance.AdminPasswordRestriction);

            FxUtils.AddListItems(RblIsLoginFailToLock, "是", "否");
            SystemWebUtils.SelectSingleItemIgnoreCase(RblIsLoginFailToLock, ConfigManager.Instance.IsAdminLockLogin.ToString());
            ...
            SystemWebUtils.SelectSingleItemIgnoreCase(DdlLoginLockingType, ConfigManager.Instance.AdminLockLoginType);
            ...
            SystemWebUtils.SelectSingleItemIgnoreCase(RblIsViewContentOnlySelf, ConfigManager.Instance.IsViewContentOnlySelf.ToString());
        }
