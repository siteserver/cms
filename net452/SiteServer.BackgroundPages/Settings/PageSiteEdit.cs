	...
	public class PageSiteEdit : BasePageCms
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SystemWebUtils.SelectSingleItem(DdlParentId, SiteInfo.ParentId.ToString());
            }
            ...
            if (SiteInfo == null)
            {
                WebPageUtils.RedirectToErrorPage("站点不存在，请确认后再试！");
                return;
            }
            TbSiteName.Text = SiteInfo.SiteName;
            SystemWebUtils.SelectSingleItem(RblIsCheckContentUseLevel, SiteInfo.IsCheckContentLevel.ToString());
            ...
            SystemWebUtils.SelectSingleItem(DdlTableChoose, SiteInfo.TableName);
        }
        ...
        {
            WebPageUtils.Redirect(PageSite.GetRedirectUrl());
        }
    }
}
