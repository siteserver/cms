...
namespace SiteServer.BackgroundPages.Settings
{
	public class PageLogError : BasePage
	{
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                SystemWebUtils.SelectSingleItem(DdlCategory, AuthRequest.GetQueryString("category"));
                SystemWebUtils.SelectSingleItem(DdlPluginId, AuthRequest.GetQueryString("pluginId"));
        ...
        private static void RptContents_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            ltlId.Text = $@"<a href=""{WebPageUtils.GetErrorPageUrl(id)}"" target=""_blank"">{id}</a>";
	    ...
	    {
	        WebPageUtils.Redirect(FxUtils.GetSettingsUrl(nameof(PageLogError), new NameValueCollection
	        {
