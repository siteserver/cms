	...
	public class PageLogSite : BasePageCms
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            if (AuthRequest.IsQueryExists("LogType"))
            {
                ...
                SystemWebUtils.SelectSingleItem(DdlLogType, AuthRequest.GetQueryString("LogType"));
        ...
        {
            WebPageUtils.Redirect(FxUtils.GetSettingsUrl(nameof(PageLogSite), new NameValueCollection
            {
