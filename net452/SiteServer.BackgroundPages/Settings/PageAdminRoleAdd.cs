        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            if (permissions.Count > 0)
            {
                ...
                if (!string.IsNullOrEmpty(_theRoleName))
                {
                    ...
                    {
                        SystemWebUtils.SelectMultiItems(CblPermissions, permissionList);
                    }
                }
            }
            ...
            {
                WebPageUtils.RedirectToErrorPage("页面超时，请重新进入。");
            }
...
";
        ...
        public override void Submit_OnClick(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(_theRoleName))
            {
                try
                {
                    ...
                    var generalPermissionList = SystemWebUtils.GetSelectedListControlValueStringList(CblPermissions);
        ...
        public void Return_OnClick(object sender, EventArgs e)
        {
            if (AuthRequest.GetQueryString("Return") != null)
            {
                WebPageUtils.Redirect(PageAdminRole.GetRedirectUrl());
            }
        }
    }
}
