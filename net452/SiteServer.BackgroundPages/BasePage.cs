...
namespace SiteServer.BackgroundPages
{
    ...
    {
        private WebPageUtils.Message.EMessageType _messageType;
...
#pragma warning restore CS0612 // '“RequestImpl”已过时
        ...
        private void SetMessage(WebPageUtils.Message.EMessageType messageType, Exception ex, string message)
        {
...
#pragma warning restore CS0612 // '“RequestImpl”已过时
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            {
                WebPageUtils.SaveMessage(_messageType, _message);
            }
...
";
        ...
        {
            SetMessage(WebPageUtils.Message.EMessageType.Error, ex, message);
        }

        public void FailMessage(string message)
        {
            SetMessage(WebPageUtils.Message.EMessageType.Error, null, message);
        }

        public void SuccessMessage(string message)
        {
            SetMessage(WebPageUtils.Message.EMessageType.Success, null, message);
        }
        ...
        {
            SetMessage(WebPageUtils.Message.EMessageType.Info, null, message);
        }

        public void SuccessDeleteMessage()
        {
            SuccessMessage(WebPageUtils.DeleteSuccess);
        }

        public void SuccessUpdateMessage()
        {
            SuccessMessage(WebPageUtils.UpdateSuccess);
        }

        public void SuccessCheckMessage()
        {
            SuccessMessage(WebPageUtils.CheckSuccess);
        }

        public void SuccessInsertMessage()
        {
            SuccessMessage(WebPageUtils.InsertSuccess);
        }

        public void FailInsertMessage(Exception ex)
        {
            FailMessage(ex, WebPageUtils.InsertFail);
        }

        public void FailUpdateMessage(Exception ex)
        {
            FailMessage(ex, WebPageUtils.UpdateFail);
        }

        public void FailDeleteMessage(Exception ex)
        {
            FailMessage(ex, WebPageUtils.DeleteFail);
        }

        public void FailCheckMessage(Exception ex)
        {
            FailMessage(ex, WebPageUtils.CheckFail);
        }
        ...
        {
            return SystemWebUtils.FindControlBySelfAndChildren(controlId, this);
        }
        ...
        public void VerifySystemPermissions(params string[] permissionArray)
        {
            ...
            WebPageUtils.Redirect(FxUtils.GetAdminUrl(string.Empty));
        }
