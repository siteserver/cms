...
namespace SiteServer.BackgroundPages.Cms
{
	public class ModalContentExport : BasePageCms
    {
        ...
        private void ConfigSettings(bool isLoad)
        {
            if (isLoad)
            {
                ...
                if (!string.IsNullOrEmpty(SiteInfo.ConfigExportDisplayAttributes))
                {
                    ...
                    SystemWebUtils.SelectMultiItems(CblDisplayAttributes, displayAttributes);
                }
            ...
            else
            {
                ...
                SiteInfo.ConfigExportDisplayAttributes = SystemWebUtils.GetSelectedListControlValueCollection(CblDisplayAttributes);
        ...
        {
            var displayAttributes = SystemWebUtils.GetSelectedListControlValueCollection(CblDisplayAttributes);
