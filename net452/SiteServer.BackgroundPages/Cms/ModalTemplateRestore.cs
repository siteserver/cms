    ...
    public class ModalTemplateRestore : BasePageCms
    {
		...
		public void Page_Load(object sender, EventArgs e)
        {
            ...
            if (logDictionary.Count > 0)
            {
                ...
                if (_logId > 0)
                {
                    SystemWebUtils.SelectSingleItem(DdlLogId, _logId.ToString());
                }
        ...
        {
            WebPageUtils.Redirect(FxUtils.GetCmsUrl(SiteId, nameof(ModalTemplateRestore), new NameValueCollection
            {
