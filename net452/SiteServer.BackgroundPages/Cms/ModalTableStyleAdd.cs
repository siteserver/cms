...
namespace SiteServer.BackgroundPages.Cms
{
    public class ModalTableStyleAdd : BasePageCms
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            SystemWebUtils.AddListItemsToInputType(DdlInputType);

            var relatedFieldInfoList = DataProvider.RelatedField.GetRelatedFieldInfoList(SiteId);
            ...
            SystemWebUtils.AddListItemsToERelatedFieldStyle(DdlRelatedFieldStyle);

            SystemWebUtils.SelectSingleItem(DdlIsRapid, _styleInfo.Id != 0 ? false.ToString() : true.ToString());
            ...
            SystemWebUtils.SelectSingleItem(DdlInputType, _styleInfo.Type.Value);
            TbTaxis.Text = _styleInfo.Taxis.ToString();
            SystemWebUtils.SelectSingleItem(DdlIsFormatString, _styleInfo.FormatString.ToString());
            ...
            SystemWebUtils.SelectSingleItem(DdlRelatedFieldId, _styleInfo.RelatedFieldId.ToString());
            SystemWebUtils.SelectSingleItem(DdlRelatedFieldStyle, _styleInfo.RelatedFieldStyle);
