...
namespace SiteServer.BackgroundPages.Cms
{
	public class PageConfigurationUploadImage : BasePageCms
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            SystemWebUtils.SelectSingleItemIgnoreCase(DdlImageUploadDateFormatString, SiteInfo.ImageUploadDateFormatString);

            FxUtils.AddListItems(DdlIsImageUploadChangeFileName, "自动修改文件名", "保持文件名不变");
            SystemWebUtils.SelectSingleItemIgnoreCase(DdlIsImageUploadChangeFileName, SiteInfo.IsImageUploadChangeFileName.ToString());
