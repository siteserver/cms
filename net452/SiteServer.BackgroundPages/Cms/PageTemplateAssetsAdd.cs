...
namespace SiteServer.BackgroundPages.Cms
{
	public class PageTemplateAssetsAdd : BasePageCms
    {
        ...
        {
            return FxUtils.GetCmsUrl(siteId, nameof(PageTemplateAssetsAdd), new NameValueCollection
            {
                {"type", type}
            });
        }
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            WebPageUtils.CheckRequestParameter("siteId", "type");
        ...
        {
            WebPageUtils.Redirect(PageTemplateAssets.GetRedirectUrl(SiteId, _type));
        }
    }
}
