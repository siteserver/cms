...
namespace SiteServer.BackgroundPages.Cms
{
    public class ModalSiteSelect : BasePageCms
    {
        ...
        {
            return FxUtils.GetCmsUrl(siteId, nameof(ModalSiteSelect), null);
        }
        ...
        private void RptContents_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            ltlName.Text = $@"<a href=""{FxUtils.GetLoadingUrl(FxUtils.GetMainUrl(siteInfo.Id, string.Empty))}"" target=""_top"">{SiteManager.GetSiteName(siteInfo)}</a>";
