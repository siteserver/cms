...
namespace SiteServer.BackgroundPages.Cms
{
	public class PageContentAddAfter : BasePageCms
    {
		...
		public void Page_Load(object sender, EventArgs e)
        {
			...
			WebPageUtils.CheckRequestParameter("siteId", "channelId", "ContentID", "ReturnUrl");
        ...
        public void RblOperation_SelectedIndexChanged(object sender, EventArgs e)
		{
            ...
            {
                WebPageUtils.Redirect(WebUtils.GetContentAddAddUrl(SiteId, _channelInfo, AuthRequest.GetQueryString("ReturnUrl")));
            }
            ...
            {
                SystemWebUtils.LoadSiteIdDropDownList(DdlSiteId, SiteInfo, _channelInfo.Id);
        ...
        public void DdlSiteId_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SystemWebUtils.LoadChannelIdListBox(LbChannelId, SiteInfo, psId, _channelInfo, AuthRequest.AdminPermissionsImpl);
        }
