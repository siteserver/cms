...
namespace SiteServer.BackgroundPages.Cms
{
	public class PageConfigurationUploadVideo : BasePageCms
    {
		...
		public void Page_Load(object sender, EventArgs e)
        {
            ...
            SystemWebUtils.SelectSingleItemIgnoreCase(DdlVideoUploadDateFormatString, SiteInfo.VideoUploadDateFormatString);

            FxUtils.AddListItems(DdlIsVideoUploadChangeFileName, "自动修改文件名", "保持文件名不变");
            SystemWebUtils.SelectSingleItemIgnoreCase(DdlIsVideoUploadChangeFileName, SiteInfo.IsVideoUploadChangeFileName.ToString());
