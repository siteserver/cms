...
namespace SiteServer.BackgroundPages.Cms
{
	public class ModalContentCrossSiteTrans : BasePageCms
    {
		...
		public void Page_Load(object sender, EventArgs e)
        {
            ...
            WebPageUtils.CheckRequestParameter("siteId", "channelId", "contentIdCollection");
            ...
            SystemWebUtils.LoadSiteIdDropDownList(DdlSiteId, SiteInfo, _channelId);
        ...
        public void DdlSiteId_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SystemWebUtils.LoadChannelIdListBox(LbChannelId, SiteInfo, psId, ChannelManager.GetChannelInfo(SiteId, _channelId), AuthRequest.AdminPermissionsImpl);
        }
