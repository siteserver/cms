...
namespace SiteServer.BackgroundPages.Cms
{
	public class PageConfigurationWaterMark : BasePageCms
    {
		...
		public void Page_Load(object sender, EventArgs e)
        {
            ...
            SystemWebUtils.SelectSingleItemIgnoreCase(DdlIsWaterMark, SiteInfo.IsWaterMark.ToString());
            ...
            SystemWebUtils.SelectSingleItemIgnoreCase(DdlWaterMarkTransparency, SiteInfo.WaterMarkTransparency.ToString());
            ...
            SystemWebUtils.SelectSingleItemIgnoreCase(DdlIsImageWaterMark, SiteInfo.IsImageWaterMark.ToString());

            TbWaterMarkFormatString.Text = SiteInfo.WaterMarkFormatString;

            LoadSystemFont();
            SystemWebUtils.SelectSingleItemIgnoreCase(DdlWaterMarkFontName, SiteInfo.WaterMarkFontName);
