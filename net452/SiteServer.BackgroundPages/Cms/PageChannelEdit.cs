...
namespace SiteServer.BackgroundPages.Cms
{
    public class PageChannelEdit : BasePageCms
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            WebPageUtils.CheckRequestParameter("siteId", "channelId", "ReturnUrl");
            ...
            if (AuthRequest.GetQueryString("CanNotEdit") == null && AuthRequest.GetQueryString("UncheckedChannel") == null)
            {
                ...
                {
                    WebPageUtils.RedirectToErrorPage("您没有修改栏目的权限！");
                    return;
                }
            }
            ...
            if (!IsPostBack)
            {
                ...
                SystemWebUtils.SelectSingleItem(DdlContentModelPluginId, channelInfo.ContentModelPluginId);
                ...
                SystemWebUtils.AddListItemsToELinkType(DdlLinkType);
                SystemWebUtils.AddListItemsToETaxisTypeForChannelEdit(DdlTaxisType);

                SystemWebUtils.AddListControlItems(CblNodeGroupNameCollection, ChannelGroupManager.GetGroupNameList(SiteId));
                ...
                SystemWebUtils.SelectSingleItem(DdlChannelTemplateId, channelInfo.ChannelTemplateId.ToString());

                DdlContentTemplateId.Items.Insert(0, new ListItem("<未设置>", "0"));
                SystemWebUtils.SelectSingleItem(DdlContentTemplateId, channelInfo.ContentTemplateId.ToString());
                ...
                SystemWebUtils.SelectSingleItem(DdlLinkType, channelInfo.LinkType);
                SystemWebUtils.SelectSingleItem(DdlTaxisType, channelInfo.DefaultTaxisType);
                SystemWebUtils.SelectSingleItem(RblIsChannelAddable, channelInfo.IsChannelAddable.ToString());
                SystemWebUtils.SelectSingleItem(RblIsContentAddable, channelInfo.IsContentAddable.ToString());
        ...
        public override void Submit_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                channelInfo.ContentRelatedPluginIds = SystemWebUtils.GetSelectedListControlValueCollection(CblContentRelatedPluginIds);
            ...
            WebPageUtils.Redirect(ReturnUrl);
        }
