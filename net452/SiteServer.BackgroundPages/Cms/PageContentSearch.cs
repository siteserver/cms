...
namespace SiteServer.BackgroundPages.Cms
{
    public class PageContentSearch : BasePageCms
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            SystemWebUtils.AddListItemsForChannel(DdlChannelId.Items, SiteInfo, true, true, AuthRequest.AdminPermissionsImpl);

            if (_isCheckOnly)
            {
                SystemWebUtils.LoadContentLevelToCheck(DdlState, SiteInfo, isChecked, checkedLevel);
            }
            else
            {
                SystemWebUtils.LoadContentLevelToCheckList(DdlState, SiteInfo, _isCheckOnly, isChecked, checkedLevel);
            }
            ...
            {
                SystemWebUtils.SelectSingleItem(DdlChannelId, _channelId.ToString());
            }
            //ControlUtils.SelectSingleItem(DdlState, AuthRequest.GetQueryString("State"));
            SystemWebUtils.SelectSingleItem(DdlSearchType, searchType);
