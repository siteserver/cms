...
namespace SiteServer.BackgroundPages.Cms
{
    public class PageTableStyleContent : BasePageCms
    {
        ...
        {
            return FxUtils.GetCmsUrl(siteId, nameof(PageTableStyleContent), new NameValueCollection
            {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            SystemWebUtils.AddListItemsForChannel(DdlChannelId.Items, SiteInfo, false, true, AuthRequest.AdminPermissionsImpl);
            SystemWebUtils.SelectSingleItem(DdlChannelId, channelId.ToString());
        ...
        {
            WebPageUtils.Redirect(GetRedirectUrl(SiteId, TranslateUtils.ToInt(DdlChannelId.SelectedValue)));
        }
        ...
        private void RptContents_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            var urlStyle = FxUtils.GetCmsUrl(SiteId, nameof(PageTableStyleContent), new NameValueCollection
            {
