...
namespace SiteServer.BackgroundPages.Cms
{
	public class ModalTableStyleValidateAdd : BasePageCms
    {
        ...
        {
            return LayerUtils.GetOpenScript("设置表单验证", FxUtils.GetCmsUrl(siteId, nameof(ModalTableStyleValidateAdd), new NameValueCollection
            {
		...
		public void Page_Load(object sender, EventArgs e)
        {
            ...
            SystemWebUtils.SelectSingleItem(DdlIsValidate, _styleInfo.Validate.ToString());

            DdlIsRequired.Items[0].Value = true.ToString();
            DdlIsRequired.Items[1].Value = false.ToString();

            SystemWebUtils.SelectSingleItem(DdlIsRequired, _styleInfo.Required.ToString());
            ...
            SystemWebUtils.SelectSingleItem(DdlValidateType, _styleInfo.ValidateType);
