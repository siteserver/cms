...
namespace SiteServer.BackgroundPages.Cms
{
	public class PageTemplateMatch : BasePageCms
    {
		...
		public void BindListBox()
		{
		    ...
		    SystemWebUtils.SelectSingleItem(LbChannelTemplateId, selectedChannelTemplateId);
		    SystemWebUtils.SelectSingleItem(LbContentTemplateId, selectedContentTemplateId);
		}
