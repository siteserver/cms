...
namespace SiteServer.CMS.Apis
{
    public class ChannelApi : IChannelApi
    {
        ...
        {
            return DataProvider.Channel.Insert(nodeInfo as ChannelInfo);
        }
        ...
        //            allChannelIdList.InsertObject(0, channelId);
        ...
        public void Update(int siteId, IChannelInfo channelInfo)
        {
            ...
            DataProvider.Channel.Update((ChannelInfo)channelInfo);
        }
