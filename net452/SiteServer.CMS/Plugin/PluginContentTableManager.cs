...
namespace SiteServer.CMS.Plugin
{
    public static class PluginContentTableManager
    {
        ...
        public static void SyncContentTable(ServiceImpl service)
        {
            ...
            {
                TableColumnManager.CreateTable(tableName, tableColumns, service.PluginId, true, out _);
            }
            else
            {
                TableColumnManager.AlterTable(tableName, tableColumns, service.PluginId, ContentAttribute.DropAttributes.Value);
            }
