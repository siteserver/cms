...
namespace SiteServer.BackgroundPages.Plugins
{
	public class ModalGatherDatabaseSet : BasePageCms
    {
        ...
        {
            return LayerUtils.GetOpenScript("信息采集", PageUtils.GetPluginsUrl(nameof(ModalGatherDatabaseSet), new NameValueCollection
            {
		...
		public void Page_Load(object sender, EventArgs e)
        {
			...
			if (!IsPostBack)
			{
                ...
                ControlUtils.SelectSingleItem(NodeIDDropDownList, gatherDatabaseRuleInfo.NodeId.ToString());
			}
		}
