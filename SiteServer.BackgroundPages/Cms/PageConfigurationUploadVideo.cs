...
namespace SiteServer.BackgroundPages.Cms
{
	public class PageConfigurationUploadVideo : BasePageCms
    {
		...
		public void Page_Load(object sender, EventArgs e)
        {
            ...
            DdlVideoUploadDateFormatString.Items.Add(new ListItem("按年存入不同目录", DateFormatType.Year.GetValue()));
            DdlVideoUploadDateFormatString.Items.Add(new ListItem("按年/月存入不同目录", DateFormatType.Month.GetValue()));
            DdlVideoUploadDateFormatString.Items.Add(new ListItem("按年/月/日存入不同目录", DateFormatType.Day.GetValue()));
            ControlUtils.SelectSingleItemIgnoreCase(DdlVideoUploadDateFormatString, Site.VideoUploadDateFormatString.GetValue());
		...
		public override void Submit_OnClick(object sender, EventArgs e)
		{
			if (Page.IsPostBack && Page.IsValid)
			{
                ...
                Site.VideoUploadDateFormatString = TranslateUtils.ToEnum(DdlVideoUploadDateFormatString.SelectedValue, DateFormatType.Month);
