...
namespace SiteServer.BackgroundPages.Cms
{
    public class PageTableStyle : BasePageCms
    {
        ...
        public static string GetRedirectUrl(int publishmentSystemId, string tableName, int relatedIdentity, string returnUrl)
        {
        ...
        public static string GetRedirectUrl(int publishmentSystemId, string tableName, int relatedIdentity, int itemId, string returnUrl)
        {
            return PageUtils.GetCmsUrl(nameof(PageTableStyle), new NameValueCollection
            {
                {"PublishmentSystemID", publishmentSystemId.ToString()},
