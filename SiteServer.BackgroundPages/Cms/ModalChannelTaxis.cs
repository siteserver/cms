...
namespace SiteServer.BackgroundPages.Cms
{
    public class ModalChannelTaxis : BasePageCms
    {
        ...
        {
            return LayerUtils.GetOpenScriptWithCheckBoxValue("栏目排序", PageUtilsEx.GetCmsUrl(siteId, nameof(ModalChannelTaxis), null), "ChannelIDCollection", "请选择需要排序的栏目！", 400, 280);
        }
