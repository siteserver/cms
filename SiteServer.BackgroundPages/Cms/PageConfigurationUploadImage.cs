...
namespace SiteServer.BackgroundPages.Cms
{
	public class PageConfigurationUploadImage : BasePageCms
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            DdlImageUploadDateFormatString.Items.Add(new ListItem("按年存入不同目录", DateFormatType.Year.GetValue()));
            DdlImageUploadDateFormatString.Items.Add(new ListItem("按年/月存入不同目录", DateFormatType.Month.GetValue()));
            DdlImageUploadDateFormatString.Items.Add(new ListItem("按年/月/日存入不同目录", DateFormatType.Day.GetValue()));
            ControlUtils.SelectSingleItemIgnoreCase(DdlImageUploadDateFormatString, Site.ImageUploadDateFormatString.GetValue());
		...
		public override void Submit_OnClick(object sender, EventArgs e)
		{
		    ...
		    Site.ImageUploadDateFormatString = TranslateUtils.ToEnum(DdlImageUploadDateFormatString.SelectedValue, DateFormatType.Month);
