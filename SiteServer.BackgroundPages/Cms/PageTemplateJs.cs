...
namespace SiteServer.BackgroundPages.Cms
{
	public class PageTemplateJs : BasePageCms
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Body.IsQueryExists("Delete"))
            {
                ...
                try
                {
                    ...
                    Body.AddSiteLog(SiteId, "删除脚本文件", $"脚本文件:{fileName}");
        ...
        private void RptContents_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            ltlView.Text = $@"<a href=""{SiteInfo.Additional.WebUrl}/js/{fileName}"" target=""_blank"">查看</a>";
            ltlEdit.Text =
                $@"<a href=""{PageTemplateJsAdd.GetRedirectUrl(SiteId, fileName)}"">编辑</a>";
            ltlDelete.Text =
                $@"<a href=""javascript:;"" onclick=""{AlertUtils.ConfirmDelete("删除文件", "此操作将删除脚本文件，确认吗", $"{GetRedirectUrl(SiteId)}&Delete={true}&FileName={fileName}")}"">删除</a>";
        }
	}
}
