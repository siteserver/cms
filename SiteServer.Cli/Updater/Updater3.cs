...
using SiteServer.Cli.Updater.Model3;
...
{
    public class Updater3 : UpdaterBase
    {
        public const string Version = "3";

        public Updater3(TreeInfo oldTreeInfo, TreeInfo newTreeInfo) : base(oldTreeInfo, newTreeInfo)
        {
        }
