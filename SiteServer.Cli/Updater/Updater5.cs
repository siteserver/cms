...
using SiteServer.Cli.Updater.Model5;
using SiteServer.Cli.Updater.Plugins.Jobs;

namespace SiteServer.Cli.Updater
{
    public class Updater5 : UpdaterBase
    {
        public const string Version = "5";

        public Updater5(TreeInfo oldTreeInfo, TreeInfo newTreeInfo) : base(oldTreeInfo, newTreeInfo)
        {
