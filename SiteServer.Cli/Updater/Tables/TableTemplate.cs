...
namespace SiteServer.Cli.Updater.Tables
{
    ...
    public partial class TableTemplate
    {
        ...
        private static readonly string NewTableName = DataProvider.Template.TableName;

        private static readonly List<DatoryColumn> NewColumns = DataProvider.Template.TableColumns;
