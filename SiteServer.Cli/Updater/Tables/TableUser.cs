...
namespace SiteServer.Cli.Updater.Tables
{
    ...
    public partial class TableUser
    {
        ...
        private static readonly string NewTableName = DataProvider.User.TableName;

        private static readonly List<DatoryColumn> NewColumns = DataProvider.User.TableColumns;
