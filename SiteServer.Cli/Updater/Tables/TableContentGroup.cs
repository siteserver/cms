...
namespace SiteServer.Cli.Updater.Tables
{
    ...
    public partial class TableContentGroup
    {
        ...
        private static readonly string NewTableName = DataProvider.ContentGroup.TableName;

        private static readonly List<DatoryColumn> NewColumns = DataProvider.ContentGroup.TableColumns;
