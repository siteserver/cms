        ...
        <div>
          ...
          <p className="quc-field quc-next-step quc-clearfix">
            <a onClick={() => {
              ...
              if (!isError) {
                client.users.sendSms(this.state.account, (err: models.Error, res: {
                  isSuccess: boolean
                  mobile: string
                  errorMessage: string
                }) => {
        ...
        <div>
          ...
          <p className="quc-field quc-field-submit">
            <a onClick={() => {
              ...
              if (!isError) {
                client.users.isCodeCorrect(this.state.mobile, this.state.smsCode, (err: models.Error, res: {
                  isCorrect: boolean
                  token: string
                }) => {
                  if (res.isCorrect) {
        ...
        <div>
          ...
          <p className="quc-field quc-next-step quc-clearfix">
            <a onClick={() => {
              ...
              if (!isError) {
                client.users.resetPasswordByToken(this.state.token, this.state.password, (err: models.Error, res: {
                  isSuccess: boolean
                  errorMessage: string
                }) => {
                  if (res.isSuccess) {
