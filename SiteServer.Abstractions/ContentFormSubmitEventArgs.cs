...
namespace SiteServer.Abstractions
{
    ...
    {
        /// <summary>
        /// 初始化 <see cref="T:SiteServer.Abstractions.ContentFormSubmitEventArgs" /> 类的新实例。
        /// </summary>
        ...
        /// <summary>
        /// 即将保存至数据库的内容对象，可以从表单数据 <see cref="T:SiteServer.Abstractions.IAttributes" /> 中获取属性值并设置到内容对象中。
        /// </summary>
