...
namespace SSCMS
{
    ...
    /// </summary>
    public interface IOldPlugin : IPackageMetadata
    {
        /// <summary>
        /// 内容添加完成后的触发事件。
        /// </summary>
        ...
        IOldPlugin SetSystemDefaultPage(string pageUrl);
        ...
        /// <param name="pageUrl">默认页面地址。</param>
        /// <returns>返回插件服务注册实例。</returns>
        IOldPlugin SetHomeDefaultPage(string pageUrl);
        ...
        /// <returns>返回插件服务注册实例。</returns>
        IOldPlugin AddContentColumn(string columnName, Func<IContentContext, string> columnFunc);
        ...
        /// </summary>
        /// <returns>返回插件服务注册实例。</returns>
        IOldPlugin AddApiAuthorization();
        /// <summary>
        ...
        /// <returns>返回插件服务注册实例。</returns>
        IOldPlugin AddJob(string command, Func<IJobContext, Task> job);
