...
namespace SiteServer.BackgroundPages.Settings
{
    public class ModalAreaAdd : BasePage
    {
        ...
        {
            return LayerUtils.GetOpenScript("添加区域", PageUtilsEx.GetSettingsUrl(nameof(ModalAreaAdd), new NameValueCollection
            {
        ...
        {
            return LayerUtils.GetOpenScript("修改区域", PageUtilsEx.GetSettingsUrl(nameof(ModalAreaAdd), new NameValueCollection
            {
