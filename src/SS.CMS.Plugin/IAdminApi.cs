...
namespace SS.CMS.Plugin
{
    ...
    public interface IAdminApi
    {
        ...
        void Log(string userName, int siteId, string action, string summary = "");

        void Log(string userName, int siteId, int channelId, string action, string summary = "");

        void Log(string userName, int siteId, int channelId, int contentId, string action, string summary = "");

        void Log(string userName, string action, string summary = "");
    }
}
