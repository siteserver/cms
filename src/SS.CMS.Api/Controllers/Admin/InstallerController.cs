...
namespace SS.CMS.Api.Controllers.Admin
{
    ...
    public class InstallerController : ControllerBase
    {
        ...
        public InstallerController(ISettingsManager settingsManager, IPluginManager pluginManager, IUserManager userManager, IUserRepository userRepository, ISiteRepository siteRepository, IConfigRepository configRepository)
        {
