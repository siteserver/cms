...
namespace SS.CMS.Core.Services.V2
{
    public class ContentsService : ServiceBase
    {
        ...
        public ContentsService(IAccessTokenRepository accessTokenRepository)
        {
        ...
        public async Task<ResponseResult<object>> Create(IRequest request, IResponse response)
        {
            ...
            else
            {
                isAuth = !string.IsNullOrEmpty(request.ApiToken) &&
                         await _accessTokenRepository.IsScopeAsync(request.ApiToken, AccessTokenManager.ScopeContents) ||
        ...
        public async Task<ResponseResult<object>> GetSiteContents(IRequest request, IResponse response)
        {
            var siteId = TranslateUtils.Get<int>(request.RouteValues, "siteId");
        ...
        public async Task<ResponseResult<object>> GetChannelContents(IRequest request, IResponse response)
        {
            var siteId = TranslateUtils.Get<int>(request.RouteValues, "siteId");
            var channelId = TranslateUtils.Get<int>(request.RouteValues, "channelId");
