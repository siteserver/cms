...
namespace SSCMS.Core.Services.PathManager
{
    public partial class PathManager
    {
        ...
        {
            return PageUtils.Combine(WebUrl, DirectoryUtils.SiteFilesDirectoryName, DirectoryUtils.SiteFiles.TemporaryFiles, relatedUrl);
        }

        public string GetSiteTemplatesUrl(string relatedUrl)
        {
            return PageUtils.Combine(WebUrl, DirectoryUtils.SiteFilesDirectoryName, DirectoryUtils.SiteTemplates.DirectoryName, relatedUrl);
        }
        ...
        {
            return PageUtils.Combine(WebUrl, DirectoryUtils.SiteFilesDirectoryName, relatedUrl);
        }
