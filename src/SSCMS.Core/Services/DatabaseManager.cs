...
namespace SSCMS.Core.Services
{
    public partial class DatabaseManager : IDatabaseManager
    {
        ...
        public IWxAccountRepository OpenAccountRepository { get; }
        public IWxMenuRepository OpenMenuRepository { get; }
