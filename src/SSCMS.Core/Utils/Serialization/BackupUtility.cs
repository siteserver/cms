...
namespace SSCMS.Core.Utils.Serialization
{
	public static class BackupUtility
	{
        ...
        public static async Task BackupTemplatesAsync(IPathManager pathManager, IDatabaseManager databaseManager, CacheUtils caching, IPluginManager pluginManager, Site site, string filePath)
        {
        ...
        public static async Task BackupChannelsAndContentsAsync(IPathManager pathManager, IDatabaseManager databaseManager, CacheUtils caching, IPluginManager pluginManager, Site site, string filePath)
        {
            var exportObject = new ExportObject(pathManager, databaseManager, caching, pluginManager, site);
        ...
        public static async Task BackupFilesAsync(IPathManager pathManager, IDatabaseManager databaseManager, CacheUtils caching, IPluginManager pluginManager, Site site, string filePath)
        {
            var exportObject = new ExportObject(pathManager, databaseManager, caching, pluginManager, site);
        ...
        public static async Task BackupSiteAsync(IPathManager pathManager, IDatabaseManager databaseManager, CacheUtils caching, IPluginManager pluginManager, Site site, string filePath)
        {
            var exportObject = new ExportObject(pathManager, databaseManager, caching, pluginManager, site);
