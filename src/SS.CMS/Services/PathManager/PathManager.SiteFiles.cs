...
namespace SS.CMS.Services
{
    public partial class PathManager
    {
        ...
        {
            return GetWebRootUrl(DirectoryUtils.SiteFiles.DirectoryName, PageUtils.Combine(paths));
        }
        ...
        {
            return GetWebRootUrl(DirectoryUtils.SiteFiles.DirectoryName, DirectoryUtils.SiteFiles.Administrators,
        ...
        {
            return GetWebRootUrl(DirectoryUtils.SiteFiles.DirectoryName, DirectoryUtils.SiteFiles.Users,
                PageUtils.Combine(userId.ToString(), PageUtils.Combine(paths)));
        }
