...
namespace SS.CMS.Services
{
    public partial class PluginManager : IPluginManager
    {
        ...
        public PluginManager(IServiceProvider serviceProvider, ISettingsManager settingsManager, IPathManager pathManager, IDatabaseManager databaseManager, IPluginConfigRepository pluginConfigRepository, IErrorLogRepository errorLogRepository)
        {
        ...
        {
            var list = _serviceProvider.GetServices<IPlugin>();
            return list.ToList();
        }
        ...
        public string GetPluginIconUrl(IPlugin pluginService)
        {
