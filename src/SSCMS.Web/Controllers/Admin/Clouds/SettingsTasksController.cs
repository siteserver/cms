...
namespace SSCMS.Web.Controllers.Admin.Clouds
{
    ...
    public partial class SettingsTasksController : ControllerBase
    {
        private const string Route = "clouds/settingsTasks";
        private const string RouteDelete = "clouds/settingsTasks/actions/delete";
        private const string RouteEnable = "clouds/settingsTasks/actions/enable";
        ...
        public SettingsTasksController(IAuthManager authManager, ICloudManager cloudManager, IConfigRepository configRepository, IScheduledTaskRepository scheduledTaskRepository, ISiteRepository siteRepository)
        {
