...
namespace SSCMS.Web.Controllers.Admin.Cms.Material
{
    ...
    public partial class ImageController : ControllerBase
    {
        ...
        public ImageController(ISettingsManager settingsManager, IAuthManager authManager, IPathManager pathManager, IOpenManager openManager, ISiteRepository siteRepository, IMaterialGroupRepository materialGroupRepository, IMaterialImageRepository materialImageRepository, IOpenAccountRepository openAccountRepository)
        {
