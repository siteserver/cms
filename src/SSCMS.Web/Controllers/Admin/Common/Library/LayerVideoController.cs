...
namespace SSCMS.Web.Controllers.Admin.Common.Library
{
    ...
    {
        private const string RouteUploadVideo = "common/library/layerVideo/actions/uploadVideo";
        private const string RouteUploadImage = "common/library/layerVideo/actions/uploadImage";
