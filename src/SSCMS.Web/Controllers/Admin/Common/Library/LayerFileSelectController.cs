...
namespace SSCMS.Web.Controllers.Admin.Common.Library
{
    ...
    {
        private const string Route = "common/library/layerFileSelect";
        private const string RouteSelect = "common/library/layerFileSelect/actions/select";
        ...
        public LayerFileSelectController(ISettingsManager settingsManager, IPathManager pathManager, ILibraryGroupRepository libraryGroupRepository, ILibraryFileRepository libraryFileRepository, ISiteRepository siteRepository)
        {
