...
var methods = {
  ...
  btnAddClick: function () {
    parent.location.hash = 'contentAdd.html?siteId=' + this.site.id + '&channelId=' + this.channel.id + '&returnUrl=' + encodeURIComponent(parent.location.hash);
  },

  btnEditClick: function (content) {
    console.log(content);
    parent.location.hash = 'contentAdd.html?siteId=' + this.site.id + '&channelId=' + content.channelId + '&contentId=' + content.id + '&returnUrl=' + encodeURIComponent(parent.location.hash);
  },
