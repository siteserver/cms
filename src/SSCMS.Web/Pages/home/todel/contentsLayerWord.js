  ...
  btnSubmitClick: function () {
    ...
    $api.post({
      ...
      if (contentIdList.length === 1) {
        parent.location.hash = 'contentAdd.html?siteId=' + $this.siteId + '&channelId=' + $this.channelId + '&contentId=' + contentIdList[0] + '&returnUrl=' + encodeURIComponent($this.returnUrl);
      } else {
