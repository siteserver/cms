var $urlUploadVideo = $apiUrl + '/common/library/layerVideo/actions/uploadVideo?siteId=' + utils.getQueryInt('siteId');
var $urlUploadImage = $apiUrl + '/common/library/layerVideo/actions/uploadImage?siteId=' + utils.getQueryInt('siteId');
