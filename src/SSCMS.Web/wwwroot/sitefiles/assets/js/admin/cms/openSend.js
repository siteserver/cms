var $url = "/cms/open/send";
var $urlUpload = "/cms/open/send/actions/upload";
var $urlPreview = "/cms/open/send/actions/preview";
...
var methods = {
  ...
  btnSelectClick: function() {
    utils.openLayer({
      title: '选择素材',
      url: utils.getCmsUrl("openSendLayer" + this.form.materialType, {
        siteId: this.siteId
       })
    });
  },
