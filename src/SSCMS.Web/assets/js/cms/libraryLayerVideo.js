var $urlUploadVideo = $apiUrl + '/admin/cms/library/libraryLayerVideo/actions/uploadVideo?siteId=' + utils.getQueryInt('siteId');
var $urlUploadImage = $apiUrl + '/admin/cms/library/libraryLayerVideo/actions/uploadImage?siteId=' + utils.getQueryInt('siteId');
