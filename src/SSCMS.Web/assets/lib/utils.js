...
var utils = {
  PER_PAGE: 30,
  ACCESS_TOKEN_NAME: 'ss_admin_access_token',
...
var $api = axios.create({
  baseURL: $apiUrl || '/api',
  headers: {
    Authorization: 'Bearer ' + (sessionStorage.getItem(utils.ACCESS_TOKEN_NAME) || localStorage.getItem(utils.ACCESS_TOKEN_NAME))
  }
});
