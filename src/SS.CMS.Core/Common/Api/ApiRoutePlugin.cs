...
namespace SS.CMS.Core.Common.Api
{
    public static class ApiRoutePlugin
    {
        ...
        public static string GetUrl(IUrlManager urlManager, string pluginId, string routeResource = "", string routeId = "", string routeAction = "")
        {
            var apiUrl = urlManager.GetApiUrl(Route);
