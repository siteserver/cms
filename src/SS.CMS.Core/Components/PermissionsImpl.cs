            ...
            get
            {
                ...
                if (_permissionList == null)
                {
                    if (EPredefinedRoleUtils.IsConsoleAdministrator(Roles))
                    {
                        ...
                        foreach (var permission in PermissionManager.Instance.GeneralPermissions)
                        {
            ...
            get
            {
                ...
                if (_websitePermissionDict == null)
                {
                    if (IsSystemAdministrator)
                    {
                        ...
                        foreach (var permission in PermissionManager.Instance.WebsitePermissions)
                        {
            ...
            get
            {
                ...
                if (_channelPermissionDict == null)
                {
                    if (EPredefinedRoleUtils.IsSystemAdministrator(Roles))
                    {
                        ...
                        foreach (var permission in PermissionManager.Instance.ChannelPermissions)
                        {
