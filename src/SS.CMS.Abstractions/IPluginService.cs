...
namespace SS.CMS.Abstractions
{
    ...
    public interface IPluginService
    {
        ...
        IPluginService SetSystemDefaultPage(string pageUrl);
        ...
        /// <param name="pageUrl">默认页面地址。</param>
        /// <returns>返回插件服务注册实例。</returns>
        IPluginService SetHomeDefaultPage(string pageUrl);
        ...
        /// <returns>返回插件服务注册实例。</returns>
        IPluginService AddSystemMenu(Func<Menu> menuFunc);
        /// <summary>
        /// 添加站点菜单。
        /// 站点菜单位于系统左侧的插件管理菜单中。
        ...
        /// <returns>返回插件服务注册实例。</returns>
        IPluginService AddSiteMenu(Func<int, Menu> menuFunc);
        ...
        /// <returns>返回插件服务注册实例。</returns>
        IPluginService AddHomeMenu(Func<Menu> menuFunc);
        ...
        /// <returns>返回插件服务注册实例。</returns>
        IPluginService AddContentMenu(Func<Content, Menu> menuFunc);
        ...
        /// <returns>返回插件服务注册实例。</returns>
        IPluginService AddContentModel(string tableName, List<TableColumn> tableColumns, List<InputStyle> inputStyles);
        /// <summary>
        ...
        /// <returns>返回插件服务注册实例。</returns>
        IPluginService AddDatabaseTable(string tableName, List<TableColumn> tableColumns);
        ...
        /// <returns>返回插件服务注册实例。</returns>
        IPluginService AddContentColumn(string columnName, Func<IContentContext, string> columnFunc);
        ...
        /// <returns>返回插件服务注册实例。</returns>
        IPluginService AddStlElementParser(string elementName, Func<IParseContext, string> parse);

        /// <summary>
        /// 添加REST Api插件授权。
        /// </summary>
        /// <returns>返回插件服务注册实例。</returns>
        IPluginService AddApiAuthorization();
        /// <summary>
        ...
        /// <returns>返回插件服务注册实例。</returns>
        IPluginService AddJob(string command, Func<IJobContext, Task> job);
