...
namespace SS.CMS.Enums
{
    ...
    public class TemplateType : IEquatable<TemplateType>, IComparable<TemplateType>
    {
        ...
        {
            if (string.Equals(IndexPageTemplate.Value, val, StringComparison.OrdinalIgnoreCase))
            {
                return IndexPageTemplate;
            }
            if (string.Equals(ChannelTemplate.Value, val, StringComparison.OrdinalIgnoreCase))
            {
                return ChannelTemplate;
            }
            if (string.Equals(ContentTemplate.Value, val, StringComparison.OrdinalIgnoreCase))
            {
