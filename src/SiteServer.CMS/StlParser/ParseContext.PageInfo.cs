...
namespace SiteServer.CMS.StlParser.Model
{
    public class PageInfo
    {
        ...
        {
            return await GetPageInfoAsync(PageChannelId, PageContentId, Site, Template, PluginItems);
        }
        ...
        public static async Task<PageInfo> GetPageInfoAsync(int pageChannelId, int pageContentId, Site site, Template template, Dictionary<string, object> pluginItems)
        {
            ...
            pageInfo.ChannelItems = new Stack<KeyValuePair<int, Channel>>(5);
            pageInfo.ContentItems = new Stack<KeyValuePair<int, Content>>(5);
            pageInfo.SqlItems = new Stack<KeyValuePair<int, Dictionary<string, object>>>(5);
            pageInfo.SiteItems = new Stack<KeyValuePair<int, Site>>(5);
            pageInfo.EachItems = new Stack<KeyValuePair<int, object>>(5);
