...
namespace SiteServer.Utils.Model
{
    [Serializable]
	public class TableStyleInfo: IComparable<TableStyleInfo>
	{
	    public TableStyleInfo()
		{
            ...
            InputType = SiteServer.Plugin.InputType.Text;
            DefaultValue = string.Empty;
            IsHorizontal = true;
            ExtendValues = string.Empty;
		}

        public TableStyleInfo(int tableStyleId, int relatedIdentity, string tableName, string attributeName, int taxis, string displayName, string helpText, bool isVisibleInList, InputType inputType, string defaultValue, bool isHorizontal, string extendValues) 
		{
