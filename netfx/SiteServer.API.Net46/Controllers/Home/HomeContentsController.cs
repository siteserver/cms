...
namespace SiteServer.API.Controllers.Home
{
    ...
    public class HomeContentsController : ControllerBase
    {
        ...
        public IHttpActionResult List()
        {
            try
            {
                ...
                var permissions = new
                {
                    IsAdd = request.UserPermissionsImpl.HasChannelPermissions(siteInfo.Id, channelInfo.Id, ConfigManager.ChannelPermissions.ContentAdd) && channelInfo.IsContentAddable,
